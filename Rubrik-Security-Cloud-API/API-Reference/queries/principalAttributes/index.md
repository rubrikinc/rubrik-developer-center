...
| filter   | [PrincipalAttributeFilter](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/PrincipalAttributeFilter/index.md) | Optional filter (IdP types, principal types, domains, prefix search on display name / SID). |
