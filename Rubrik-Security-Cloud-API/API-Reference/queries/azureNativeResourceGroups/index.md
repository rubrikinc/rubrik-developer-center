...
| sortBy                        | [AzureNativeCommonResourceGroupSortFields](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/AzureNativeCommonResourceGroupSortFields/index.md) | Sort fields for listing Azure resource groups.                           |
| sortOrder                     | [SortOrder](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/SortOrder/index.md)                                                               | Sorts the order of results.                                              |
| commonResourceGroupFilters    | [AzureNativeCommonResourceGroupFilters](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/AzureNativeCommonResourceGroupFilters/index.md)      | Filters for listing Azure resource groups.                               |
| protectedObjectTypes          | \[[WorkloadLevelHierarchy](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/WorkloadLevelHierarchy/index.md)!\]                                | List of protected object types.                                          |
