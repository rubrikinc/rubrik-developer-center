...
| requestedAggregations | \[[SnappableAggregationsEnum](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/SnappableAggregationsEnum/index.md)!\] | Aggregation columns to compute.                                          |
