...
| filter   | [AccessFilter](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/AccessFilter/index.md) | Filter to be applied when retrieving access granting identities.         |
