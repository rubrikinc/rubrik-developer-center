...
| proxySettings                 | [ProxySettingsInput](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/ProxySettingsInput/index.md)       | Proxy configuration for the reader Rubrik cluster to reach this Rubrik Cloud Vault (RCV) Azure location.                            |
