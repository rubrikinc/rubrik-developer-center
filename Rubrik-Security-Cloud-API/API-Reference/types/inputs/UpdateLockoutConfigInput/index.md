...
| inactiveLockoutConfig           | [InactiveLockoutConfigInput](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/InactiveLockoutConfigInput/index.md) | Specifies information about inactive lockout configuration.                              |
