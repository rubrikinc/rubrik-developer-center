...
| id                     | [UUID](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/UUID/index.md)!                                               | Rubrik Security Cloud managed ID of the S3 compatible target to be edited. |
| immutabilitySettings   | [LocationImmutabilitySettings](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/LocationImmutabilitySettings/index.md) | Immutability information of S3-compatible location.                        |
