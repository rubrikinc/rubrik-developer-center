...
| passwordOptions      | [ActiveDirectoryUserPasswordRecoveryOption](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/ActiveDirectoryUserPasswordRecoveryOption/index.md) | Supported in v9.0+ Options for the recovery of the user's password.                                  |
