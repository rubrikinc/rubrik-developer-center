...
| daysOfMonth   | \[[MonthlyDaySpecInput](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/MonthlyDaySpecInput/index.md)!\]          | List the days in a month on which you want a snapshot with monthly frequency to be taken. |
