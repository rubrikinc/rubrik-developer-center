...
| updateProperties | [SapHanaSystemPatchInput](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/SapHanaSystemPatchInput/index.md)! | Required. v5.3-v8.1: An object that contains the updated SLA Domain ID for the SAP HANA system. v9.0+: An object that contains the system properties to be updated for the SAP HANA system. |
