...
| dnsRecoveryType     | [DnsRecoveryType](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/DnsRecoveryType/index.md) | DNS recovery type for all DCs. Uses cdmrestservice.DnsRecoveryType enum.                      |
| forestId            | String!                                                                                                                      | Root domain SID of the forest to recover.                                                     |
| recoveryPointInTime | [DateTime](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/DateTime/index.md)             | Operator's chosen recovery point-in-time for the forest recovery.                             |
