...
| cloudSpecificParams      | [CloudSpecificParamsInput](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/CloudSpecificParamsInput/index.md) | Cloud-specific mapping options keyed by cloud provider.                                  |
