...
| monHosts                    | \[[OpenstackMonHostInput](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/OpenstackMonHostInput/index.md)!\]! | Required. Supported in v9.5+ The list of Ceph monitor hosts.            |
