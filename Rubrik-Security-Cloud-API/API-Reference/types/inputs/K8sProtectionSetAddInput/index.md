...
| kubernetesNamespace | String    | Supported in v9.1+ Kubernetes namespace to which the protection set to be added belongs.                            |
| name                | String!   | Required. Supported in v9.1+ Name of the Kubernetes protection set to be added.                                     |
| rsType              | String!   | Required. Supported in v9.1+ Type of the Kubernetes protection set to be added.                                     |
