...
| source       | [NativeTagSource](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/NativeTagSource/index.md) | Source system that owns the native tags.                                            |
