...
| featuresToUpgrade | \[[FeatureWithPermissionsGroups](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/FeatureWithPermissionsGroups/index.md)!\] | Features with their permission groups to upgrade or install on the GCP cloud account, which are currently in the update permissions state. |
