...
| vmUpdateProperties | [VirtualMachineUpdateWithSecretV2Input](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/inputs/VirtualMachineUpdateWithSecretV2Input/index.md) | Properties to update.          |
