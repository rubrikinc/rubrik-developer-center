...
| GENERIC *(deprecated: Use specific vendor types instead of GENERIC)*                                         | Generic NAS.              |
...
| GPFS                                                                                                         | GPFS.                     |
| ISILON                                                                                                       | Isilon.                   |
| NETAPP *(deprecated: Use FSXN (AWS FSx for NetApp ONTAP) or other specific vendor types instead of NETAPP.)* | NetApp.                   |
