...
| CUSTOM_ORACLE_EE      | DB engine is Custom Oracle EE.      |
| CUSTOM_ORACLE_EE_CDB  | DB engine is Custom Oracle EE CDB.  |
| CUSTOM_ORACLE_SE2     | DB engine is Custom Oracle SE2.     |
| CUSTOM_ORACLE_SE2_CDB | DB engine is Custom Oracle SE2 CDB. |
| DB2_AE                | DB engine is DB2 AE.                |
| DB2_SE                | DB engine is DB2 SE.                |
| MARIADB               | DB engine is MariaDB.               |
| MYSQL                 | DB engine is MySQL.                 |
| ORACLE_EE             | DB engine is Oracle EE.             |
| ORACLE_EE_CDB         | DB engine is Oracle EE CDB.         |
| ORACLE_SE             | DB engine is Oracle SE.             |
| ORACLE_SE1            | DB engine is Oracle SE1.            |
| ORACLE_SE2            | DB engine is Oracle SE2.            |
| ORACLE_SE2_CDB        | DB engine is Oracle SE2 CDB.        |
