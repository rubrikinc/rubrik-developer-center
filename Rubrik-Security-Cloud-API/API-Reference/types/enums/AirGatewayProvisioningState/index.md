...
| GATEWAY_PROVISIONING_STATE_DELETING        | The gateway is being torn down; it no longer serves traffic and will be removed.                                                                |
| GATEWAY_PROVISIONING_STATE_DELETION_FAILED | Teardown of the gateway did not complete and is being retried; the gateway no longer serves traffic and will be removed once teardown succeeds. |
