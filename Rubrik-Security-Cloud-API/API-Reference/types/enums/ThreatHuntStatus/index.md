...
| Value               | Description                                                                                         |
| ------------------- | --------------------------------------------------------------------------------------------------- |
| ABORTED             | Aborted: The threat hunt got internally aborted due to very large number of file matches.           |
...
| PENDING             | Pending: This represents that the set of snapshots has not yet been determined for the threat hunt. |
