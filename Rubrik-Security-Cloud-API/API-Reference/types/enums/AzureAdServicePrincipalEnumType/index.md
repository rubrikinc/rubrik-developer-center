...
| SERVICE_PRINCIPAL_TYPE_SERVICE_IDENTITY | Entra ID service principal type is service identity (agent identity).       |
| SERVICE_PRINCIPAL_TYPE_SOCIAL_IDP       | Entra ID service principal type is social identity provider (internal use). |
