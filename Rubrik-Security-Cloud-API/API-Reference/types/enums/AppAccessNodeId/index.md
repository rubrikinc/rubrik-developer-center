...
Closed set of slot roles that can appear in AppAccessGraph.nodes. Each value appears at most once per response. Slots with no content are omitted entirely.
