...
| DERIVED *(deprecated: Nothing returns this sync type; it will be removed in a future release.)* | The target of the pending action can be derived from the pending action. |
