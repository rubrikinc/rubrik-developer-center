...
| FIELD_UNSPECIFIED                | Unspecified filter field for MSSQL Availability Group virtual group results.           |
| IS_RBA_ROLE_SECONDARY            | Is RBA role secondary filter field for MSSQL Availability Group virtual group results. |
| IS_RELIC                         | Is Relic filter field for MSSQL Availability Group virtual group results.              |
