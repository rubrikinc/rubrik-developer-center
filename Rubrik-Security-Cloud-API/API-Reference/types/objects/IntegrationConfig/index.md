...
| panXsoar           | [PanXsoarIntegrationConfig](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/PanXsoarIntegrationConfig/index.md)                   | The Palo Alto Networks XSOAR configuration. |
| sailPoint          | [SailPointIntegrationConfig](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/SailPointIntegrationConfig/index.md)                 | The SailPoint configuration.                |
...
| workday            | [WorkdayIntegrationConfig](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/WorkdayIntegrationConfig/index.md)                     | The Workday configuration.                  |
