...
| daysOfWeek    | \[[WeeklyDaySpec](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/WeeklyDaySpec/index.md)!\]!           | List of days of the week on which we want snapshots to be taken for the weekly frequency (1-7 days). |
