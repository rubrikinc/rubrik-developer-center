...
| yearStartMonth | [SlaMonth](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/SlaMonth/index.md)!                                      | Required. Supported in v9.5+ The month when the year begins. This determines the year boundaries. For example, if January (default), the year is Jan-Dec. If April, the year is Apr-Mar.                                                                                                            |

## Used By

**Referenced by**

- [ConfiguredSchedule.daysOfYear](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/ConfiguredSchedule/index.md)
