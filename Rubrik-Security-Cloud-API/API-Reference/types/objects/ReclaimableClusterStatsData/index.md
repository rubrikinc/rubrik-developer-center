...
| protectedObjectsStorage    | [Long](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/Long/index.md)! | Storage taken by protected objects excluding downloaded snapshots (in bytes).                              |
