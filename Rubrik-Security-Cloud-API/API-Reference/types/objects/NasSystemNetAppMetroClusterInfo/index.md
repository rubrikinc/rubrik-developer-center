...
| partnerNasSystemCdmIdOpt | [UUID](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/UUID/index.md) | The cdm-id of partner NAS system, if registered. |

## Used By

**Referenced by**

- [NasSystem.netAppMetroClusterInfo](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/NasSystem/index.md)
