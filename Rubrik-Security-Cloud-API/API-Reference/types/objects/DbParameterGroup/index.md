...
- [query: allDbParameterGroupsByRegionFromAws](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/queries/allDbParameterGroupsByRegionFromAws/index.md)
