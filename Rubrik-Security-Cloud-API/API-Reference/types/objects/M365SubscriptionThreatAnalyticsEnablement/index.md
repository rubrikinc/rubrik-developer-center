...
| id                         | String!  | M365 ID.                                            |
| isHealthy                  | Boolean! | Indicates whether the M365 organization is healthy. |
| orgName                    | String!  | M365 organization name.                             |
...
- [ThreatAnalyticsEnablement.m365Subscriptions](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/ThreatAnalyticsEnablement/index.md)
