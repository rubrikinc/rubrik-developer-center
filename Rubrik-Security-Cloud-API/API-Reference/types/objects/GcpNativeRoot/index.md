...
| ------------------------------ | --------------------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------- |
| objectTypeDescendantConnection | [GcpNativeHierarchyObjectConnection](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/GcpNativeHierarchyObjectConnection/index.md)! | List of descendants of specific object type. |
...
- [query: gcpNativeRoot](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/queries/gcpNativeRoot/index.md)
