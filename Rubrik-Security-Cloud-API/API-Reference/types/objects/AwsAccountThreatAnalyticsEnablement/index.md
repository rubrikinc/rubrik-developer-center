...
| serviceType                | [AwsCloudAccountServiceType](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/AwsCloudAccountServiceType/index.md)! | The service classification of the AWS account: Backup as a Service (BaaS) or standard (non-BaaS). |
...
- [ThreatAnalyticsEnablement.awsAccounts](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/ThreatAnalyticsEnablement/index.md)
