...
| tagPermissions                | \[[TagPermission](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/TagPermission/index.md)!\]!                | Tag-scoped permissions of the role. Populated for tag-scoped roles and empty for object-scoped roles. |
