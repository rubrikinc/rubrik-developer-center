...
- [CreateCustomDataTypeReply.dataType](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/CreateCustomDataTypeReply/index.md)
...
- [UpdateCustomDataTypeReply.dataType](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/UpdateCustomDataTypeReply/index.md)
