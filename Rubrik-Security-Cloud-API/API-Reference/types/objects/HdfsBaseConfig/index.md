...
| hosts          | \[[HdfsHost](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/HdfsHost/index.md)!\]! | Required. Supported in v5.2-v9.1 List of Hdfs Namenode Hosts.    |
...
- [HostSummary.hdfsBaseConfig](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/HostSummary/index.md)
