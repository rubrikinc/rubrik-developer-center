...
| ------------------------------------ | ---------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------- |
| containerArchiveDetails              | [ContainerArchiveDetails](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/ContainerArchiveDetails/index.md) | Details of the archive container when the matched file is an inner entry discovered via archive expansion. Unset when is_inside_archive is false. |
