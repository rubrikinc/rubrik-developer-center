...
| serviceType     | [AwsCloudAccountServiceType](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/AwsCloudAccountServiceType/index.md)!                | Service type indicating whether the account is onboarded for Backup-as-a-Service (BaaS) or non-BaaS use case. |
...
- [AwsNativeConfig.awsNativeAccountDetails](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/AwsNativeConfig/index.md)
