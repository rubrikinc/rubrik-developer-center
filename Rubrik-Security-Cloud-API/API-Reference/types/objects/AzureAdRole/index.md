...
| policy           | [AzureAdPimPolicy](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/AzureAdPimPolicy/index.md) | Parsed PIM policy detail, populated only on detail view. |
