...
| internalTimestamp  | [Long](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/Long/index.md)! | Internal timestamp of the job.                   |
...
- [query: ccProvisionMetadata](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/queries/ccProvisionMetadata/index.md)
