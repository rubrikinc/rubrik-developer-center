...
| daysOfMonth   | \[[MonthlyDaySpec](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/MonthlyDaySpec/index.md)!\]!         | List the days in a month on which you want a snapshot with monthly frequency to be taken. |
