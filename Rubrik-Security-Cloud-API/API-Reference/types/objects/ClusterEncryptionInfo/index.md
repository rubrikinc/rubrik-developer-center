...
| clusterProductType          | [ClusterProductType](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/ClusterProductType/index.md)!          | The product type of the Rubrik cluster.                                  |
