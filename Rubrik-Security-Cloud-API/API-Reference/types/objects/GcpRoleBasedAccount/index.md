...
| project          | [GcpCloudAccountGetProjectReply](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/GcpCloudAccountGetProjectReply/index.md)! | The GCP project details.                     |
