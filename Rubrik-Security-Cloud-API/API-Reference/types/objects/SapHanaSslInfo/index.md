...
| encryptionProvider        | [SapHanaSslInfoEncryptionProvider](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/SapHanaSslInfoEncryptionProvider/index.md)! | Required. SAP HANA SSL information encryption provider.                                                        |
...
- [SapHanaSystemSummary.sslInfo](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/SapHanaSystemSummary/index.md)
