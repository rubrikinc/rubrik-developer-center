...
Specifies Attribute Filtering criteria to define member of groups. For AD group, members would be users, where as for Configured group members would be Teams/ SharePoint.
...
| isArchived     | Boolean!                                                                                                                          | Specifies if the attribute is archived.               |
