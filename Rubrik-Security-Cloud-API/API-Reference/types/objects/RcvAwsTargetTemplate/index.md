...
| encryptionType             | [TargetEncryptionTypeEnum](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/TargetEncryptionTypeEnum/index.md)!     | Encryption type for the RCV AWS location template.                            |
