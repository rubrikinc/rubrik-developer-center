...
| ---------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------- | -------------------------------------------------------------------------------------------------------------------- |
| data       | \[[UpdateNetworkThrottleReply](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/UpdateNetworkThrottleReply/index.md)!\]! | Supported in v5.0+ List of matching objects.                                                                         |
...
- [query: networkThrottle](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/queries/networkThrottle/index.md)
