...
| mountTimestamp   | [DateTime](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/DateTime/index.md) | Supported in v9.6+ Timestamp at which the mount was created.                                      |
| mountedVmId      | String                                                                                                           | Supported in v9.6+ ID of the mounted virtual machine on FusionCompute.                            |
| snapshotDate     | [DateTime](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/DateTime/index.md) | Supported in v9.6+ Date of the source snapshot.                                                   |
