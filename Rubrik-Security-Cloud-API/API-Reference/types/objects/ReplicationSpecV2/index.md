...
| databaseLogRetentionInfo          | [DatabaseLogRetentionInfoType](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/DatabaseLogRetentionInfoType/index.md) | Per-workload database transaction log retention policy for this location. |
