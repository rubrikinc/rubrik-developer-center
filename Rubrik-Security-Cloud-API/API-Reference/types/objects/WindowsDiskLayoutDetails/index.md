...
| partitions | \[[WindowsPartitionInfo](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/WindowsPartitionInfo/index.md)!\]! | List of partitions on the disks.                 |
