...
| registeredMode      | [RegisteredMode](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/RegisteredMode/index.md)!          | Supported in v8.0+ Mode of registration for the Rubrik cluster. |
| rubrikUrl           | [URL](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/URL/index.md)!                              | Supported in v8.0+ Global manager URL.                          |
