...
| hypervVm             | [HypervVirtualMachineResourceSpec](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/HypervVirtualMachineResourceSpec/index.md)           | HyperV virtual machine resource specification.       |
