...
- [query: awsMarketplaceSubscriptionInfo](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/queries/awsMarketplaceSubscriptionInfo/index.md)
