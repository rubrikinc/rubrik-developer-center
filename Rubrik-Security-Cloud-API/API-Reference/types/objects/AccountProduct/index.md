...
| state          | [ProductState](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/enums/ProductState/index.md)! | State of the product - Active, disabled, etc. |
