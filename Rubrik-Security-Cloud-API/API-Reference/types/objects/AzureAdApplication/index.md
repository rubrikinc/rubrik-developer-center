...
| linkedServicePrincipal | [EntraIdLinkedServicePrincipal](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/EntraIdLinkedServicePrincipal/index.md) | Service principal that shares the app ID of the Entra ID application. Absent when the tenant has no service principal for the application. |
