...
| redoLogPositionOpt    | [Long](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/Long/index.md)  | Redo log position for the backup.                                       |
...
- [SapHanaAppMetadata.files](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/SapHanaAppMetadata/index.md)
