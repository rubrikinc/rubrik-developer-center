...
| recoveryPlans    | \[[M365AbrRecoveryPlan](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/M365AbrRecoveryPlan/index.md)!\]! | Recovery Plans associated with this minimum viable company profile. Archived Recovery Plans are excluded. Empty list when no Recovery Plans exist. |
