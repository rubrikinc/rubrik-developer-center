...
| registryPatterns      | \[[RegistryPatternSpec](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/RegistryPatternSpec/index.md)!\]! | Windows registry key search patterns for this hunt. |
