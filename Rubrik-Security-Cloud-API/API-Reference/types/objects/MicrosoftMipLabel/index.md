...
| parentInfo           | [ParentLabelInfo](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/ParentLabelInfo/index.md) | Represents the parent label information.      |
...
- [query: allMipLabels](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/queries/allMipLabels/index.md)
