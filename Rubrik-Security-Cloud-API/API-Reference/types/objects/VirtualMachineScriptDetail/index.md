...
- [AdvancedVirtualMachineSummary.postBackupScript](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/AdvancedVirtualMachineSummary/index.md)
- [AdvancedVirtualMachineSummary.postSnapScript](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/AdvancedVirtualMachineSummary/index.md)
- [AdvancedVirtualMachineSummary.preBackupScript](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/AdvancedVirtualMachineSummary/index.md)
