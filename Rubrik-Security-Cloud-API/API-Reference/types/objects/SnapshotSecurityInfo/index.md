...
| suspiciousFileCount | [Long](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/scalars/Long/index.md)!                                          | Number of suspicious files detected in this snapshot. |
