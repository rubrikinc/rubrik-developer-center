...
- [query: agentDeploymentSetting](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/queries/agentDeploymentSetting/index.md)

**Mutations**

- [mutation: updateAgentDeploymentSetting](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/mutations/updateAgentDeploymentSetting/index.md)

**Referenced by**

- [AgentDeploymentSettingsInfo.agentDeploymentSettings](https://developer.rubrik.com/Rubrik-Security-Cloud-API/API-Reference/types/objects/AgentDeploymentSettingsInfo/index.md)
