...
| LOCATION_REDUNDANCY | Filter the RCV archival entity by location redundancy. |
...
| REDUNDANCY_CONVERSION_STATUS | Filter the RCV archival entity by its redundancy conversion status. |
