...
| ENTRA_ID_TOKEN_RESPONSE_SIGNING_POLICY_UNKNOWN | Default zero value. Indicates the signing policy was not set or did not match any known Microsoft Graph value. |
