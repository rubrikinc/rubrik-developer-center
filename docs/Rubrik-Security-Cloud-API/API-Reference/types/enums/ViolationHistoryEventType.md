...
| HISTORY_EVENT_REMEDIATION_CLOSED | A remediation against the violation was closed (abandoned / no longer applicable). Distinct from COMPLETED -- the remediation did not run to success; it was terminated by the orchestrator or operator. |
