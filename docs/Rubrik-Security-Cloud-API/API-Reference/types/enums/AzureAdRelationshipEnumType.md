...
| GROUP_ACTIVE_ASSIGNMENT | Group-side PIM active assignment relationship for an Entra ID group. |
...
| PRINCIPAL_GROUP_ACTIVE_ASSIGNMENT | Principal-side PIM group active assignment (User/Group to assignment schedule). |
...
| SSO_POLICY_EXTENSION *(deprecated: The SSO Policy Extension relationship has been removed.)* | The application that a claims mapping policy extends. |
