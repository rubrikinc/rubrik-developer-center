...
Zeus (columnar relational store) provisioning lifecycle for a DevOps organization. Values are prefixed DEVOPS_ZEUS_* because proto3 namespaces enum values at the file level.
