...
| SNAPSHOT_LOCATION_TYPE_BACKUP | Primary backup-group location for Rubrik Security Cloud workloads. |
...
| SNAPSHOT_LOCATION_TYPE_REPLICATION | Replication target location. |
| SNAPSHOT_LOCATION_TYPE_SOURCE | Primary source-copy location for Rubrik Security Cloud workloads. |
