...
| environmentType | [SaasEnvironmentType](../enums/SaasEnvironmentType.md)! | The environment type of the Google Workspace organization. |
| id | [UUID](../scalars/UUID.md)! | ID of the hierarchy object. |
| lastRefreshTime | [DateTime](../scalars/DateTime.md) | The time at which the Google Workspace organization was last synced to Rubrik. |
...
| orgUrl | [URL](../scalars/URL.md)! | The URL of the Google Workspace organization. |
| physicalPath | [[PathNode](PathNode.md)!]! | Sequential list of the physical ancestors of this object. |
| rbacHierarchyNodes | [[SaasRbacHierarchyNode](SaasRbacHierarchyNode.md)!]! | List of RBAC hierarchy nodes. |
...
| status | [SaasOrganizationStatus](../enums/SaasOrganizationStatus.md)! | The status of the Google Workspace organization. |
| storageRegion | String | The RSC storage region for the organization. |
| storageRegions | [SaasAppsOrgStorageLocations](SaasAppsOrgStorageLocations.md)! | The storage regions where RSC backs up organization's data. |
