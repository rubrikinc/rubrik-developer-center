...
OLVM compute cluster.

**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [OlvmManagerDescendant](../interfaces/OlvmManagerDescendant.md), [OlvmDatacenterDescendant](../interfaces/OlvmDatacenterDescendant.md), [OlvmManagerPhysicalChildType](../interfaces/OlvmManagerPhysicalChildType.md), [OlvmDatacenterPhysicalChildType](../interfaces/OlvmDatacenterPhysicalChildType.md)
...
| cdmId | String! | ID of OLVM compute cluster on Rubrik CDM. |
...
| computerClusterName | String! | Name of the OLVM compute cluster. |
...
| datacenterId | String! | ID of the OLVM datacenter that contains this compute cluster. |
| descendantConnection | [OlvmComputeClusterDescendantConnection](OlvmComputeClusterDescendantConnection.md)! | List of descendants. |
...
| olvmId | String! | ID of the compute cluster in OLVM. |
| olvmManagerId | String! | ID of the OLVM manager that manages this compute cluster. |
...
| physicalChildConnection | [OlvmComputeClusterPhysicalChildTypeConnection](OlvmComputeClusterPhysicalChildTypeConnection.md)! | List of physical children. |
