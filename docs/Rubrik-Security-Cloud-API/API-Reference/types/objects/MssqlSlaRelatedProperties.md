...
- [MssqlAvailabilityGroupSummary.mssqlSlaRelatedProperties](MssqlAvailabilityGroupSummary.md)
- [MssqlInstanceSummary.mssqlSlaRelatedProperties](MssqlInstanceSummary.md)
