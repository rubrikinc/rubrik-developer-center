...
| lastSignInDateTime | [DateTime](../scalars/DateTime.md) | Date and time of the device's last sign-in activity. |
| mdm | String! | Mobile Device Management (MDM) authority managing the device. |
| onPremSyncStatus | [AzureAdOnPremSyncStatus](../enums/AzureAdOnPremSyncStatus.md)! | On-premises sync status of the Entra ID device. |
...
| registrationDateTime | [DateTime](../scalars/DateTime.md) | Date and time when the device was registered in Entra ID. |
| trustType | [AzureAdDeviceTrustType](../enums/AzureAdDeviceTrustType.md)! | Trust relationship type between the device and Entra ID. |
