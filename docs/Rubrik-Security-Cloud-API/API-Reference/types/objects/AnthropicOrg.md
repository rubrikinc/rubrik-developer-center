...
An Anthropic organization managed by Rubrik.
...
| lastRefreshTime | [DateTime](../scalars/DateTime.md) | The time at which the Anthropic organization was last synced to Rubrik. |
| logicalPath | [[PathNode](PathNode.md)!]! | Sequential list of the logical ancestors of this object. |
| name | String! | Name of the hierarchy object. |
| naturalId | String! | ID of the Anthropic organization at the source. |
...
| status | [SaasOrganizationStatus](../enums/SaasOrganizationStatus.md)! | The lifecycle status of the Anthropic organization. |
