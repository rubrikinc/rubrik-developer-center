...
|-------|------|-------------|
| accessTier | [AzureStorageAccessTier](../enums/AzureStorageAccessTier.md)! | The access tier of the storage account. |
| accountKind | [AzureStorageAccountKind](../enums/AzureStorageAccountKind.md)! | The Storage Account type. |
