...
|-------|------|-------------|
| data | [[CreateGuestCredentialReply](CreateGuestCredentialReply.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: guestCredentials](../../queries/guestCredentials.md)
