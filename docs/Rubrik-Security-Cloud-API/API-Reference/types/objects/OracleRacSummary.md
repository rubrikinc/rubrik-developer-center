...
| nodeOrder | [[OracleNodeOrder](OracleNodeOrder.md)!]! | Required. Supported in v5.0+ Specifies an order for the RAC nodes. Automated Oracle backups use the RAC nodes in the specified order. |
| nodes | [[OracleNodeProperties](OracleNodeProperties.md)!]! | Required. Supported in v5.0+ Details of the nodes of this Oracle RAC. |
...
| shouldEnableMultiNodeBackup | Boolean | Supported in v9.6 Boolean value that specifies whether multi-node backup is enabled for this Oracle RAC. |
...
- [OracleRacDetail.oracleRacSummary](OracleRacDetail.md)
