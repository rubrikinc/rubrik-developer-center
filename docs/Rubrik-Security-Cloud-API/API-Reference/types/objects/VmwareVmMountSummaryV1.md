...
| mountTimestamp | [DateTime](../scalars/DateTime.md) | Supported in v5.0+ Gives the timestamp at which the mount was created. |
...
- [VsphereVmPowerOnOffLiveMountReply.vmwareVmMountSummaryV1](VsphereVmPowerOnOffLiveMountReply.md)
