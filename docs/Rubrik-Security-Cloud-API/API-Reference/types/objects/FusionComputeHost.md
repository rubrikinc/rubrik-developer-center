...
| descendantConnection | [FusionComputeHostDescendantConnection](FusionComputeHostDescendantConnection.md)! | List of descendants. |
...
| physicalChildConnection | [FusionComputeHostPhysicalChildTypeConnection](FusionComputeHostPhysicalChildTypeConnection.md)! | List of physical children. |
...
- [query: fusionComputeHost](../../queries/fusionComputeHost.md)
- [query: fusionComputeHosts](../../queries/fusionComputeHosts.md) *(via connection)*
