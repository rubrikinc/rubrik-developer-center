...
| status | [HostRbsStatus](../enums/HostRbsStatus.md)! | Required. Supported in v6.0+ The status of the Rubrik Backup Service on the host. |

## Used By

**Referenced by**

- [RbsHostInstallStatus.summary](RbsHostInstallStatus.md)
