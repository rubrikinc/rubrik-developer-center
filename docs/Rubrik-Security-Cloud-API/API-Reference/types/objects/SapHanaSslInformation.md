...
| encryptionProvider | [SapHanaEncryptionProvider](../enums/SapHanaEncryptionProvider.md)! | The encryption provider for the SAPA HANA system. |
...
- [SapHanaSystem.sslInfo](SapHanaSystem.md)
