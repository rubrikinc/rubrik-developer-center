...
| clusterId | String! | Rubrik-generated unique identifier for the AlloyDB cluster. |
| clusterType | String! | Cluster type (PRIMARY or SECONDARY for cross-region replication). |
| configuredSlaDomain | [SlaDomain](../interfaces/SlaDomain.md)! | SLA Domain configured for the hierarchy object. |
| databaseVersion | String! | Database version (e.g., POSTGRES_14). |
...
| isExocomputeConfigured | Boolean! | Specifies whether exocompute is configured for use by this AlloyDB cluster. |
| isRelic | Boolean! | Indicates if the cluster is archived/deleted. |
...
| nativeId | String! | Cloud provider's native ID for the cluster. |
| nativeName | String! | Display name of the AlloyDB cluster. |
...
| projectId | String! | ID of the GCP project containing this cluster. |
| region | String! | Region of the AlloyDB cluster. |
