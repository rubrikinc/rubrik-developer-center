...
**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [CdmHierarchySnappableNew](../interfaces/CdmHierarchySnappableNew.md), [HierarchySnappable](../interfaces/HierarchySnappable.md), [OpenstackEnvironmentDescendantType](../interfaces/OpenstackEnvironmentDescendantType.md), [OpenstackEnvironmentLogicalChildType](../interfaces/OpenstackEnvironmentLogicalChildType.md), [OpenstackEnvironmentPhysicalChildType](../interfaces/OpenstackEnvironmentPhysicalChildType.md), [OpenstackRegionDescendantType](../interfaces/OpenstackRegionDescendantType.md), [OpenstackRegionPhysicalChildType](../interfaces/OpenstackRegionPhysicalChildType.md), [OpenstackAvailabilityZoneDescendantType](../interfaces/OpenstackAvailabilityZoneDescendantType.md), [OpenstackAvailabilityZonePhysicalChildType](../interfaces/OpenstackAvailabilityZonePhysicalChildType.md), [OpenstackHostDescendantType](../interfaces/OpenstackHostDescendantType.md), [OpenstackHostPhysicalChildType](../interfaces/OpenstackHostPhysicalChildType.md), [OpenstackDomainDescendantType](../interfaces/OpenstackDomainDescendantType.md), [OpenstackDomainLogicalChildType](../interfaces/OpenstackDomainLogicalChildType.md), [OpenstackProjectDescendantType](../interfaces/OpenstackProjectDescendantType.md), [OpenstackProjectLogicalChildType](../interfaces/OpenstackProjectLogicalChildType.md), [OpenstackTagDescendantType](../interfaces/OpenstackTagDescendantType.md), [OpenstackTagLogicalChildType](../interfaces/OpenstackTagLogicalChildType.md)

## Fields

| Field | Type | Description |
|-------|------|-------------|
| agentStatus | [OpenstackVmAgentStatus](OpenstackVmAgentStatus.md) | Agent status of the OpenStack virtual machine. |
...
| flavorName | String! | Name of the flavor associated with the OpenStack virtual machine. |
| id | [UUID](../scalars/UUID.md)! | ID of the hierarchy object. |
| imageName | String! | Name of the image associated with the OpenStack virtual machine. |
| isRelic | Boolean! | Whether the OpenStack virtual machine is a relic. |
...
| networkTags | [[OpenstackNetworkTags](OpenstackNetworkTags.md)!]! | List of network tags associated with the OpenStack virtual machine. |
...
| snapshotConsistencyMandate | String | Snapshot consistency mandate configured for the OpenStack virtual machine. Null when no mandate is configured. |
