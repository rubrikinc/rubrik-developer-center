...
| mcpServerIds | [[UUID](../scalars/UUID.md)!]! | IDs of the MCP servers attached to this gateway. |
| status | [AirGatewayProvisioningState](../enums/AirGatewayProvisioningState.md)! | Current provisioning state of the gateway deployment. |
...
- [AirUpdateMcpGatewayReply.gateway](AirUpdateMcpGatewayReply.md)
