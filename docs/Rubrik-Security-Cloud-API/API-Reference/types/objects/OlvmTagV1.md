...
**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [OlvmManagerDescendant](../interfaces/OlvmManagerDescendant.md), [OlvmTagDescendant](../interfaces/OlvmTagDescendant.md), [OlvmTagLogicalChild](../interfaces/OlvmTagLogicalChild.md)
...
| cdmId | String! | ID of OLVM tag on Rubrik CDM. |
...
| descendantConnection | [OlvmTagDescendantConnection](OlvmTagDescendantConnection.md)! | List of descendants. |
...
| logicalChildConnection | [OlvmTagLogicalChildConnection](OlvmTagLogicalChildConnection.md)! | List of logical children. |
...
| objectIds | [String!]! | IDs of the OLVM virtual machines on Rubrik CDM that this tag is applied to. |
| objectPauseStatus | [ObjectPauseStatus](ObjectPauseStatus.md) | Pause status of the hierarchy object. |
| objectType | [HierarchyObjectTypeEnum](../enums/HierarchyObjectTypeEnum.md)! | Type of this object. |
| olvmManagerId | String! | ID of the OLVM manager that owns this tag. |
| parentTagId | [UUID](../scalars/UUID.md) | Unique identifier of the parent OLVM tag. Null for root tags attached directly to the OLVM manager. |
...
| slaDomainId | String! | Configured SLA domain id assigned to this tag (or INHERIT). |
| slaPauseStatus | Boolean! | Pause status of the effective SLA Domain of the hierarchy object. |
| snapshotDistribution | [SnapshotDistribution](SnapshotDistribution.md)! | Distribution of the snapshots of the hierarchy object. |
| tagName | String! | Name of the OLVM tag. |
...
| logicalChildConnection | last | Int | Returns the last n elements from the list. |
| logicalChildConnection | before | String | Returns the elements in the list that occur before the specified cursor. |
