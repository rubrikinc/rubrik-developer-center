...
**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [NutanixTopLevelDescendantType](../interfaces/NutanixTopLevelDescendantType.md), [NutanixPrismCentralDescendantType](../interfaces/NutanixPrismCentralDescendantType.md), [NutanixPrismCentralLogicalChildType](../interfaces/NutanixPrismCentralLogicalChildType.md)
...
| clusterMetadata | [NutanixClusterMetadata](NutanixClusterMetadata.md) | Nutanix cluster metadata. |
| clusterNetworks | [[NutanixClusterNetwork](NutanixClusterNetwork.md)!]! | Networks of the Nutanix cluster. |
| configuredSlaDomain | [SlaDomain](../interfaces/SlaDomain.md)! | SLA Domain configured for the hierarchy object. |
| connectionStatus | [RefreshableObjectConnectionStatus](RefreshableObjectConnectionStatus.md)! | Connection status of the Nutanix Cluster. If the CDM cluster is disconnected, then the status is set to 'Disconnected'. |
...
| descendantConnection | [NutanixClusterDescendantTypeConnection](NutanixClusterDescendantTypeConnection.md)! | List of descendants. |
...
| naturalId | String! | Natural ID of Nutanix cluster. |
...
| storageContainers | [[NutanixStorageContainer](NutanixStorageContainer.md)!]! | Storage containers of the Nutanix cluster. |
...
- [query: nutanixCluster](../../queries/nutanixCluster.md)
- [query: nutanixClusters](../../queries/nutanixClusters.md) *(via connection)*
