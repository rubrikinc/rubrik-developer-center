...
|-------|------|-------------|
| data | [[BrowseResponse](BrowseResponse.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: filesetSnapshotFiles](../../queries/filesetSnapshotFiles.md)
- [query: nutanixBrowseSnapshot](../../queries/nutanixBrowseSnapshot.md)
