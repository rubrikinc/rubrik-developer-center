...
|-------|------|-------------|
| data | [[MissedSnapshot](MissedSnapshot.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: nutanixVmMissedSnapshots](../../queries/nutanixVmMissedSnapshots.md)
- [query: oracleMissedSnapshots](../../queries/oracleMissedSnapshots.md)
