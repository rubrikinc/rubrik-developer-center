...
| cdmId | String! | Id associated with Db2 instance in CDM. |
...
| containsHadrDatabase | Boolean! | Specifies whether the Db2 instance contains an HADR database. |
...
| descendantConnection | [Db2InstanceDescendantTypeConnection](Db2InstanceDescendantTypeConnection.md)! | List of descendants. |
...
| physicalChildConnection | [Db2InstancePhysicalChildTypeConnection](Db2InstancePhysicalChildTypeConnection.md)! | List of physical children. |
...
| status | [Db2Status](../enums/Db2Status.md)! | Current status for the Db2 instance: OK, WARNING, ERROR or UNKNOWN. |
| statusMessage | [String!]! | Additional information about the current status of the Db2 instance. |
...
- [query: db2Instance](../../queries/db2Instance.md)
- [query: db2Instances](../../queries/db2Instances.md) *(via connection)*

**Referenced by**

- [Db2Database.db2Instance](Db2Database.md)
- [Db2HadrInstanceInfo.db2Instance](Db2HadrInstanceInfo.md)
