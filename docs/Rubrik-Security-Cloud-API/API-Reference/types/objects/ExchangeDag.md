...
| backupPreference | String! | Backup Preference for databases present in the Exchange Dag. |
| cdmId | String! | ID associated with the Exchange DAG in CDM. |
...
| descendantConnection | [ExchangeDagDescendantTypeConnection](ExchangeDagDescendantTypeConnection.md)! | List of descendants. |
...
| totalHosts | Int! | Number of hosts associated with the Exchange DAG. |
...
- [query: exchangeDag](../../queries/exchangeDag.md)
- [query: exchangeDags](../../queries/exchangeDags.md) *(via connection)*

**Referenced by**

- [ExchangeServer.exchangeDag](ExchangeServer.md)
