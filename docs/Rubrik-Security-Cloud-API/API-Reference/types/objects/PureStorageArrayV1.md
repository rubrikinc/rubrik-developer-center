...
A Pure Storage array managed by Rubrik.
...
| cdmId | String! | ID of the array on the Rubrik cluster. |
...
| connectionStatus | [RefreshableObjectConnectionStatus](RefreshableObjectConnectionStatus.md)! | Connection status between Rubrik and the array. |
...
| descendantConnection | [PureStorageArrayDescendantV1Connection](PureStorageArrayDescendantV1Connection.md)! | List of descendants. |
| effectiveRetentionSlaDomain | [SlaDomain](../interfaces/SlaDomain.md) | Effective retention of the SLA Domain of the hierarchy object. |
| effectiveSlaDomain | [SlaDomain](../interfaces/SlaDomain.md)! | Effective SLA Domain of the hierarchy object. |
| effectiveSlaSourceObject | [PathNode](PathNode.md) | Path node of the effective SLA Domain source. |
| hostName | String! | Hostname or IP address of the array. |
...
| logicalChildConnection | [PureStorageArrayLogicalChildTypeConnection](PureStorageArrayLogicalChildTypeConnection.md)! | List of logical children. |
...
| primaryClusterUuid | [UUID](../scalars/UUID.md)! | UUID of the Rubrik cluster managing this array. |
| pureStorageId | String! | ID of the array in Pure Storage. |
...
| version | String | Pure Storage software version of the array. |
...
- [query: pureStorageArrayV1](../../queries/pureStorageArrayV1.md)
- [query: pureStorageArraysV1](../../queries/pureStorageArraysV1.md) *(via connection)*
