...
|-------|------|-------------|
| childConnection | [PolarisHierarchyObjectConnection](PolarisHierarchyObjectConnection.md)! | List of children. |
| descendantConnection | [PolarisHierarchyObjectConnection](PolarisHierarchyObjectConnection.md)! | List of descendants. |
| rootEnum | [InventorySubHierarchyRootEnum](../enums/InventorySubHierarchyRootEnum.md)! |  |
| topLevelDescendantConnection | [PolarisHierarchyObjectConnection](PolarisHierarchyObjectConnection.md)! | List of top-level descendants (with respect to RBAC). |
...
- [query: polarisInventorySubHierarchyRoot](../../queries/polarisInventorySubHierarchyRoot.md)
