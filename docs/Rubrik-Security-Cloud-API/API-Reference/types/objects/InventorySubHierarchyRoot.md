...
|-------|------|-------------|
| childConnection | [HierarchyObjectConnection](HierarchyObjectConnection.md)! | List of children. |
| descendantConnection | [HierarchyObjectConnection](HierarchyObjectConnection.md)! | List of descendants. |
| rootEnum | [InventorySubHierarchyRootEnum](../enums/InventorySubHierarchyRootEnum.md)! |  |
| topLevelDescendantConnection | [HierarchyObjectConnection](HierarchyObjectConnection.md)! | List of top-level descendants (with respect to RBAC). |
...
- [query: inventorySubHierarchyRoot](../../queries/inventorySubHierarchyRoot.md)
