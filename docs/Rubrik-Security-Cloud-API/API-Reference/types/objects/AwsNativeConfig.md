...
AWS native configuration for application protection.
...
| isProtectable | Boolean! | Indicates whether this AWS configuration is protectable or not. |
| isRelic | Boolean! | Specifies whether this AWS configuration is a relic. |
