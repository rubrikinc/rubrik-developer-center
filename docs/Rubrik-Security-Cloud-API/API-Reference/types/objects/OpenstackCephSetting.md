...
| monHosts | [[OpenstackMonHost](OpenstackMonHost.md)!]! | Required. Supported in v9.5+ The list of Ceph monitor hosts. |
...
- [SetCephSettingsReply.data](SetCephSettingsReply.md)
