...
|-------|------|-------------|
| data | [[OracleMissedRecoverableRange](OracleMissedRecoverableRange.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: oracleMissedRecoverableRanges](../../queries/oracleMissedRecoverableRanges.md)
