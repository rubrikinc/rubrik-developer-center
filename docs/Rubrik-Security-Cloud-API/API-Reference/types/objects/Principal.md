...
| principalType | [PrincipalTypeEnum](../enums/PrincipalTypeEnum.md)! | Type of the principal. |

## Used By

**Queries**

- [query: ldapPrincipalConnection](../../queries/ldapPrincipalConnection.md) *(via connection)*
