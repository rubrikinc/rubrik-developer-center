...
|-------|------|-------------|
| baseSnapshotSummary | [BaseSnapshotSummary](BaseSnapshotSummary.md) | The base information of a snapshot that is common across other workloads. |
...
- [OracleRecoverableRange.dbSnapshotSummaries](OracleRecoverableRange.md)
