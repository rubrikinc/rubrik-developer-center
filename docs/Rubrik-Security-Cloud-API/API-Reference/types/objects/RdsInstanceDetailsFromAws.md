...
| backupRetentionPeriod | [Long](../scalars/Long.md)! | Retention time for RDS backups. |
...
| iops | [Long](../scalars/Long.md)! | Input/Output (IO) operation limit per second for RDS Instance. |
...
- [query: rdsInstanceDetailsFromAws](../../queries/rdsInstanceDetailsFromAws.md)
