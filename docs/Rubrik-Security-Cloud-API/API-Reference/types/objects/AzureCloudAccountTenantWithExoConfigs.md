...
| subscriptions | [[AzureSubscriptionWithExoConfigs](AzureSubscriptionWithExoConfigs.md)!]! | Details of subscriptions for the tenant. |

## Used By

**Queries**

- [query: azureCloudAccountTenantWithExoConfigs](../../queries/azureCloudAccountTenantWithExoConfigs.md)
