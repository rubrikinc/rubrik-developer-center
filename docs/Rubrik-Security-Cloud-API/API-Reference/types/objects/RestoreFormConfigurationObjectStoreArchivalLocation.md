...
| numBuckets | [Long](../scalars/Long.md) | Supported in v8.0+ Number of buckets. |

## Used By

**Referenced by**

- [RestoreFormConfigurations.objectStoreArchivalLocations](RestoreFormConfigurations.md)
