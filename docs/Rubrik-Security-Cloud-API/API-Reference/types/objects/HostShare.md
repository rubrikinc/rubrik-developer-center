...
| descendantConnection | [HostShareDescendantTypeConnection](HostShareDescendantTypeConnection.md)! | List of descendants. |
...
| physicalChildConnection | [HostSharePhysicalChildTypeConnection](HostSharePhysicalChildTypeConnection.md)! | List of physical children. |
...
- [query: hostShare](../../queries/hostShare.md)
- [query: hostShares](../../queries/hostShares.md) *(via connection)*

**Referenced by**

- [ShareFileset.share](ShareFileset.md)
