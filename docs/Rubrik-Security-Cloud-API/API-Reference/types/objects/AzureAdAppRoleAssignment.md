...
| principalType | [AzureAdObjectType](../enums/AzureAdObjectType.md)! | Principal type of the Entra ID app role. |
...
- [AzureAdObjects.azureAdAppRoleAssignment](AzureAdObjects.md)
