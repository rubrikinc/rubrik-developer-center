...
|-------|------|-------------|
| databaseType | [DatabaseType](../enums/DatabaseType.md)! | Required. The type of the database. |
...
| lastSnapshotTime | [DateTime](../scalars/DateTime.md) | Supported in v5.3+ Time, in UTC, of the last database backup. |
| latestRecoveryTime | [DateTime](../scalars/DateTime.md) | Supported in v5.3+ Latest point in time, in UTC, to which the database can be restored. |
...
| logBackupDelay | [Long](../scalars/Long.md) | Supported in v5.3+ Amount of time, in seconds, that has elapsed since the next expected log backup. |
...
- [DbLogReportSummaryListReply.data](DbLogReportSummaryListReply.md)
