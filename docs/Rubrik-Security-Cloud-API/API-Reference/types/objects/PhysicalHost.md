...
| cdmId | String! | Rubrik CDM ID of the physical host. |
...
| connectionStatus | [HostConnectionStatus](HostConnectionStatus.md) | Connection status of the physical host. |
...
| hostVolumes | [[CdmHostVolume](CdmHostVolume.md)!]! | Volumes on the physical host. |
| id | [UUID](../scalars/UUID.md)! | ID of the hierarchy object. |
| ipAddresses | [String!]! | IP addresses of the physical host. |
| isArchived | Boolean! | Specifies whether the physical host is archived. |
...
| osName | String | Name of the operating system running on the physical host. |
...
| vfdState | String! | Volume Filter Driver (VFD) state of the physical host. |
