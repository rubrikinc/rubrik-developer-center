...
| status | [ClusterStatus](../enums/ClusterStatus.md)! | Connected status of the cluster. |

## Used By

**Referenced by**

- [RemoveClusterTprReqChangesTemplate.tprClusterRemovalDetails](RemoveClusterTprReqChangesTemplate.md)
