...
|-------|------|-------------|
| customResourceDependencies | [[CustomResourceDependency](CustomResourceDependency.md)!]! | Supported in v9.6+ Custom Resource dependency list. Present for rsType "application" only. |
...
| labelSelector | [CdmLabelSelector](CdmLabelSelector.md) | Supported in v9.6+ Label selector for entry-point workload filtering. Present for rsType "application" only. |
| name | String! | Required. Supported in v9.1+ Name of the Kubernetes protection set. |
| namespaceExcludePatterns | [String!]! | Supported in v9.6+ Namespace exclusion patterns. Present for rsType "application" only. |
| namespaceIncludePatterns | [String!]! | Supported in v9.6+ Namespace names or patterns included in an Application Protection Set. Present for rsType "application" only. |
