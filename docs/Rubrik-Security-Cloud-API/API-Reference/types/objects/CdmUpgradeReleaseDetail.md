...
|-------|------|-------------|
| adoptionStatus | [AdoptionStatus](../enums/AdoptionStatus.md)! | The customer adoption status of the Rubrik CDM release. |
| description | String! | Description of CDM release. |
| eosDate | String! | End of support date for version. |
| eosStatus | [EosStatus](../enums/EosStatus.md)! | The end of support status of the Rubrik CDM release. |
...
- [CdmUpgradeReleaseDetailsFromSupportPortalReply.releaseDetails](CdmUpgradeReleaseDetailsFromSupportPortalReply.md)
