...
|-------|------|-------------|
| data | [[OracleRecoverableRange](OracleRecoverableRange.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: oracleRecoverableRanges](../../queries/oracleRecoverableRanges.md)
