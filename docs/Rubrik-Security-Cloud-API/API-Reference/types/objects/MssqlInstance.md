...
- [query: mssqlInstance](../../queries/mssqlInstance.md)

**Referenced by**

- [CdmMssqlDbReplica.instance](CdmMssqlDbReplica.md)
- [MssqlAvailabilityGroup.instances](MssqlAvailabilityGroup.md)
- [MssqlDatabaseLiveMount.targetInstance](MssqlDatabaseLiveMount.md)
- [MssqlLogShippingTarget.secondaryInstance](MssqlLogShippingTarget.md)
