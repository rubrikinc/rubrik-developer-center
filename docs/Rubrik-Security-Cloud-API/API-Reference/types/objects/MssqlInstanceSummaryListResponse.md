...
|-------|------|-------------|
| data | [[MssqlInstanceSummary](MssqlInstanceSummary.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: mssqlCompatibleInstances](../../queries/mssqlCompatibleInstances.md)
