...
**Implements:** [HierarchyObject](../interfaces/HierarchyObject.md), [PolarisHierarchyObject](../interfaces/PolarisHierarchyObject.md), [MongodbSourceDescendantType](../interfaces/MongodbSourceDescendantType.md), [MongodbSourcePhysicalChildType](../interfaces/MongodbSourcePhysicalChildType.md)
...
| backupParams | [MongodbBackupParams](MongodbBackupParams.md) | Backup parameters for the MongoDB database. |
| cluster | [Cluster](Cluster.md)! | Mosaic cluster information. |
| clusterUuid | [UUID](../scalars/UUID.md)! | UUID of the Nosql cluster. |
| configuredSlaDomain | [SlaDomain](../interfaces/SlaDomain.md)! | SLA Domain configured for the hierarchy object. |
| descendantConnection | [MongodbDatabaseDescendantTypeConnection](MongodbDatabaseDescendantTypeConnection.md)! | List of descendants. |
...
| physicalChildConnection | [MongodbDatabasePhysicalChildTypeConnection](MongodbDatabasePhysicalChildTypeConnection.md)! | List of physical children. |
...
| source | [MongodbSource](MongodbSource.md)! | Parent source connection. |
...
- [query: mongodbDatabase](../../queries/mongodbDatabase.md)
- [query: mongodbDatabases](../../queries/mongodbDatabases.md) *(via connection)*

**Referenced by**

- [MongodbCollection.database](MongodbCollection.md)
