...
| versionState | [MosaicVersionObjectVersionState](../enums/MosaicVersionObjectVersionState.md) | Supported in m3.2.0-m4.2.0 Status of the version. |

## Used By

**Referenced by**

- [ListVersionResponse.data](ListVersionResponse.md)
