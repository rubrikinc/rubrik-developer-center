...
| preview | [[ClassificationPreview](ClassificationPreview.md)!]! | Represents the list of classification previews for this column. |

## Used By

**Referenced by**

- [SampleOutput.columns](SampleOutput.md)
