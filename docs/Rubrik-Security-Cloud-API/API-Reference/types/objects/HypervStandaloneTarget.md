...
| nics | [[HypervStandaloneNicSpec](HypervStandaloneNicSpec.md)!]! | Network configuration for each NIC of the recovered virtual machine. |

## Used By

**Referenced by**

- [HypervTargetConfig.standalone](HypervTargetConfig.md)
