...
|-------|------|-------------|
| groupId | [UUID](../scalars/UUID.md)! | Object ID of the group that the user is a member of. |
...
- [EntraIDUserMetadataProperties.shadowAdmins](EntraIDUserMetadataProperties.md)
