...
| arrayId | String! | ID of the Pure Storage array this volume belongs to. |
| authorizedOperations | [[Operation](../enums/Operation.md)!]! | The authorized operations on the object. |
| cdmId | String! | ID of the volume on the Rubrik cluster. |
...
| isRelic | Boolean! | Whether the volume has been deleted from Pure Storage. |
...
| primaryClusterUuid | [UUID](../scalars/UUID.md)! | UUID of the Rubrik cluster managing this volume. |
| protectionGroupRefs | [[PureStorageProtectionGroupRefV1](PureStorageProtectionGroupRefV1.md)!]! | Protection groups that contain this volume, each with its snapshot-exclusion state. |
| pureStorageId | String! | ID of the volume in Pure Storage. |
...
| reportWorkload | [Snappable](Snappable.md) | Statistics for the Pure Storage volume (for example, capacity). |
| securityMetadata | [SecurityMetadata](SecurityMetadata.md) | Security posture metadata. |
| serialNumber | String! | Serial number of the volume. |
| size | [Long](../scalars/Long.md)! | Capacity of the volume in bytes. |
...
- [query: pureStorageVolumeV1](../../queries/pureStorageVolumeV1.md)
- [query: pureStorageVolumesV1](../../queries/pureStorageVolumesV1.md) *(via connection)*
