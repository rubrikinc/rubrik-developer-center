...
|-------|------|-------------|
| adapterType | [NetworkAdapterType](../enums/NetworkAdapterType.md)! | Network adapter type (E1000, VMXNET3, etc.). |
...
| networkType | [NetworkType](../enums/NetworkType.md)! | Network configuration type (STATIC or DHCP). |

## Used By

**Referenced by**

- [VsphereVmRecoverySpec.nics](VsphereVmRecoverySpec.md)
