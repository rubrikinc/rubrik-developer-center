...
|-------|------|-------------|
| customerTags | [[TagObject](TagObject.md)!]! | List of customer-specified tags applied to all resources associated with a specific cloud type. |
...
- [query: cloudNativeCustomerTags](../../queries/cloudNativeCustomerTags.md)
