...
|-------|------|-------------|
| data | [[MssqlRecoverableRange](MssqlRecoverableRange.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: mssqlRecoverableRanges](../../queries/mssqlRecoverableRanges.md)
