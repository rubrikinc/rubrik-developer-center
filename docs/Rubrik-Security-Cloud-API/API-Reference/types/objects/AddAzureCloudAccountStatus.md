...
| error | String! | Error encountered, if any. |

## Used By

**Referenced by**

- [AddAzureCloudAccountReply.status](AddAzureCloudAccountReply.md)
- [AddAzureCloudAccountWithoutOauthReply.status](AddAzureCloudAccountWithoutOauthReply.md)
