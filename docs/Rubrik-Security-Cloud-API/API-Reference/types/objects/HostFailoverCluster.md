...
**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [FailoverClusterTopLevelDescendantType](../interfaces/FailoverClusterTopLevelDescendantType.md)

## Fields

| Field | Type | Description |
|-------|------|-------------|
| allNodes | [[PhysicalHost](PhysicalHost.md)!]! | The list of Hosts making up this Host Failover Cluster. |
...
| descendantConnection | [HostFailoverClusterDescendantTypeConnection](HostFailoverClusterDescendantTypeConnection.md)! | List of descendants. |
...
| nodesOsType | [GuestOsType](../enums/GuestOsType.md) | The OS type of the host failover cluster. |
...
| physicalChildConnection | [HostFailoverClusterPhysicalChildTypeConnection](HostFailoverClusterPhysicalChildTypeConnection.md)! | List of physical children. |
...
- [query: hostFailoverCluster](../../queries/hostFailoverCluster.md)
- [query: hostFailoverClusters](../../queries/hostFailoverClusters.md) *(via connection)*

**Referenced by**

- [FailoverClusterApp.hostFailoverCluster](FailoverClusterApp.md)
