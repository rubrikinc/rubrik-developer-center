...
**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchySnappable](../interfaces/HierarchySnappable.md), [CdmHierarchySnappableNew](../interfaces/CdmHierarchySnappableNew.md), [HierarchyObject](../interfaces/HierarchyObject.md), [SapHanaSystemPhysicalChildType](../interfaces/SapHanaSystemPhysicalChildType.md), [SapHanaSystemDescendantType](../interfaces/SapHanaSystemDescendantType.md)
...
| backupTriggerType | [BackupTriggerType](../enums/BackupTriggerType.md) | The backup trigger type for the SAP HANA database. |
...
| clusterUuid | [UUID](../scalars/UUID.md)! | UUID of cluster associated with SAP HANA database. |
...
| dataPathSpec | [SapHanaDataPathSpecObject](SapHanaDataPathSpecObject.md) | Specifications for data path. This is used when data path is not LOCAL. |
...
| sapHanaSystem | [SapHanaSystem](SapHanaSystem.md)! | SAP HANA System for the given database. |
...
| sourceDatabaseDetails | [SapHanaDatabase](SapHanaDatabase.md) | Details of the source SAP HANA database configured for the system copy. |
...
| logSnapshotConnection | sortOrder | [SortOrder](../enums/SortOrder.md) | Sorts the order of results. |
| logSnapshotConnection | sortBy | [SapHanaLogSnapshotSortBy](../enums/SapHanaLogSnapshotSortBy.md) | Field to sort SAP HANA log snapshots. |
...
| recoverableRangeConnection | sortOrder | [SortOrder](../enums/SortOrder.md) | Sorts the order of results. |
| recoverableRangeConnection | sortBy | [SapHanaRecoverableRangeSortBy](../enums/SapHanaRecoverableRangeSortBy.md) | Field to sort SAP HANA recoverable ranges. |
| recoverableRangeConnection | filter | [SapHanaRecoverableRangeFilterInput](../inputs/SapHanaRecoverableRangeFilterInput.md) | Field to filter SAP HANA recoverable ranges. |
...
- [query: sapHanaDatabase](../../queries/sapHanaDatabase.md)
- [query: sapHanaDatabases](../../queries/sapHanaDatabases.md) *(via connection)*

**Referenced by**

- [SapHanaDatabase.sourceDatabaseDetails](SapHanaDatabase.md)
