...
|-------|------|-------------|
| objectTypeDescendantConnection | [AwsNativeHierarchyObjectConnection](AwsNativeHierarchyObjectConnection.md)! | List of descendants of specific object type. |
...
- [query: awsNativeRoot](../../queries/awsNativeRoot.md)
