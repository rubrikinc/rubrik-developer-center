...
| lastRefreshedAt | [DateTime](../scalars/DateTime.md) | Timestamp of the most recent forecast refresh for the group. Unset when no forecast data is available yet. |
| redundancy | [RcvRedundancy](../enums/RcvRedundancy.md)! | Redundancy level of this entitlement group. |
...
| tier | [RcvTier](../enums/RcvTier.md)! | Tier of this entitlement group. |
...
- [query: allRcvEntitlementRunways](../../queries/allRcvEntitlementRunways.md)
