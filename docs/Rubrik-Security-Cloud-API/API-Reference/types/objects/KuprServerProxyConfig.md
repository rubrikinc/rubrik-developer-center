...
| ipAddress | String! | Required. Supported in v9.2+ The IP address of kupr server proxy for either nodeport or loadbalancer. |
...
- [K8sClusterSummary.kuprServerProxyConfig](K8sClusterSummary.md)
