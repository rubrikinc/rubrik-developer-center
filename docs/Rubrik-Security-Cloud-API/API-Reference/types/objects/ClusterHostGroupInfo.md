...
| hostGroups | [[HostGroupInfo](HostGroupInfo.md)!]! | Required. Supported in v6.0+ Host groups configured in the compute cluster. |
...
- [VcenterPreAddInfo.clusterHostGroupInfo](VcenterPreAddInfo.md)
