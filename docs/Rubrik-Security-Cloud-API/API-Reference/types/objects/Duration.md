...
- [AwsRdsConfig.logRetention](AwsRdsConfig.md)
- [CascadingArchivalSpec.archivalThreshold](CascadingArchivalSpec.md)
- [ClusterSlaDomain.baseFrequency](ClusterSlaDomain.md)
- [ClusterSlaDomain.localRetentionLimit](ClusterSlaDomain.md)
- [Db2Config.differentialFrequency](Db2Config.md)
- [Db2Config.incrementalFrequency](Db2Config.md)
- [Db2Config.logRetention](Db2Config.md)
- [GcpCloudSqlConfig.logRetention](GcpCloudSqlConfig.md)
- [GlobalSlaReply.baseFrequency](GlobalSlaReply.md)
- [GlobalSlaReply.localRetentionLimit](GlobalSlaReply.md)
- [InformixSlaConfig.incrementalFrequency](InformixSlaConfig.md)
...
- [MssqlConfig.logRetention](MssqlConfig.md)
- [MysqldbSlaConfig.logFrequency](MysqldbSlaConfig.md)
- [MysqldbSlaConfig.logRetention](MysqldbSlaConfig.md)
