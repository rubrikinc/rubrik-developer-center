...
| encryptionType | [TargetEncryptionTypeEnum](../enums/TargetEncryptionTypeEnum.md)! | Encryption type used for the RCV GCP target. |
...
| proxySettings | [ProxySettings](ProxySettings.md) | Proxy configuration used by the Rubrik cluster to reach this Rubrik Cloud Vault GCP location. |
...
| shouldBypassProxy | Boolean! | Specifies whether the proxy settings is bypassed for the RCV GCP archival target. |
...
| tier | [RcsTierEnumType](../enums/RcsTierEnumType.md)! | Tier for RCV GCP target. |
