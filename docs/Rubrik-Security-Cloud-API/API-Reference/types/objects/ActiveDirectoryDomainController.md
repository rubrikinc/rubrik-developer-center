...
**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [ActiveDirectoryDomainDescendantType](../interfaces/ActiveDirectoryDomainDescendantType.md), [ActiveDirectoryDomainPhysicalChildType](../interfaces/ActiveDirectoryDomainPhysicalChildType.md), [HierarchySnappable](../interfaces/HierarchySnappable.md), [CdmHierarchySnappableNew](../interfaces/CdmHierarchySnappableNew.md)

## Fields

| Field | Type | Description |
|-------|------|-------------|
| activeDirectoryDomain | [ActiveDirectoryDomain](ActiveDirectoryDomain.md)! | Active Directory Domain to which this domain controller belongs to. |
| adServiceStatus | [ActiveDirectoryServiceStatus](ActiveDirectoryServiceStatus.md)! | Service status of the Active Directory. |
...
| newestCleanSnapshot | [CdmSnapshot](CdmSnapshot.md) | The most recent snapshot that is not corrupted. |
...
| rbsStatus | [HostConnectionStatus](HostConnectionStatus.md)! | RBS status. |
...
| serverRoles | [[ServerRoles](../enums/ServerRoles.md)!]! | Mentions if services like DNS or DHCP are hosted. |
...
| vsphereVirtualMachines | [VsphereVmConnection](VsphereVmConnection.md) | VMWare virtual machine associated with the domain controller. |
...
| newestCleanSnapshot | beforeTime | [DateTime](../scalars/DateTime.md) | Specifies the time at which or before the snapshot was taken. |
...
- [query: activeDirectoryDomainController](../../queries/activeDirectoryDomainController.md)
- [query: activeDirectoryDomainControllers](../../queries/activeDirectoryDomainControllers.md) *(via connection)*
