...
| id | [UUID](../scalars/UUID.md)! | ID of the Azure DevOps repository. |
| isRelic | Boolean! | True if the Azure DevOps repository is a relic. |
...
| orgId | [UUID](../scalars/UUID.md)! | ID of the Azure DevOps organization associated with the repository. |
| orgName | String! | Name of the Azure DevOps organization associated with the repository. |
| physicalPath | [[PathNode](PathNode.md)!]! | Sequential list of the physical ancestors of this object. |
| projectId | [UUID](../scalars/UUID.md)! | ID of the Azure DevOps project associated with the repository. |
| projectName | String! | Name of the Azure DevOps project associated with the repository. |
...
| size | [Long](../scalars/Long.md)! | Size of the Azure DevOps repository in bytes. |
...
| url | [URL](../scalars/URL.md)! | URL of the Azure DevOps repository. |
...
- [query: azureDevOpsRepository](../../queries/azureDevOpsRepository.md)
- [query: azureDevOpsRepositories](../../queries/azureDevOpsRepositories.md) *(via connection)*
