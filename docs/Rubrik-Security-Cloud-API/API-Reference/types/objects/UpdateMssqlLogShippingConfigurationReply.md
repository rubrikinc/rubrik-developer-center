...
|-------|------|-------------|
| links | [MssqlLogShippingLinks](MssqlLogShippingLinks.md) | Required. Supported in v5.3+ |
| mssqlLogShippingSummaryV2 | [MssqlLogShippingSummaryV2](MssqlLogShippingSummaryV2.md) | Updated detail of the log shipping configuration object. |
...
- [mutation: updateMssqlLogShippingConfiguration](../../mutations/updateMssqlLogShippingConfiguration.md)
