...
|-------|------|-------------|
| data | [[MssqlMissedRecoverableRange](MssqlMissedRecoverableRange.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: mssqlDatabaseMissedRecoverableRanges](../../queries/mssqlDatabaseMissedRecoverableRanges.md)
