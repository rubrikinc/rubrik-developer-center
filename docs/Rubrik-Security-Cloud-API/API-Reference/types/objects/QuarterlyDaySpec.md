...
| firstQuarterStartMonth | [SlaMonth](../enums/SlaMonth.md)! | Required. Supported in v9.5+ The month when Q1 begins. This determines the quarter boundaries. For example, if January, quarters are Jan-Mar, Apr-Jun, Jul-Sep, Oct-Dec. If April, quarters are Apr-Jun, Jul-Sep, Oct-Dec, Jan-Mar. |
...
- [ConfiguredSchedule.daysOfQuarter](ConfiguredSchedule.md)
