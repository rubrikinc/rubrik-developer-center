...
| clusterUuid | [UUID](../scalars/UUID.md)! | The unique ID generated for the Kubernetes (k8s) cluster that was connected to RSC. |

## Used By

**Mutations**

- [mutation: exocomputeClusterConnect](../../mutations/exocomputeClusterConnect.md)
