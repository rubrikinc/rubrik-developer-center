...
| descendantConnection | [NasSystemDescendantTypeConnection](NasSystemDescendantTypeConnection.md)! | List of descendants. |
...
| lastStatus | [NasSystemConnectivityStatus](../enums/NasSystemConnectivityStatus.md)! | Specifies the connectivity status of the NAS System. |
| latestUserNote | [LatestUserNote](LatestUserNote.md) | Latest user note information. |
| logicalChildConnection | [NasSystemLogicalChildTypeConnection](NasSystemLogicalChildTypeConnection.md)! | List of logical children. |
...
- [query: nasSystem](../../queries/nasSystem.md)
- [query: nasSystems](../../queries/nasSystems.md) *(via connection)*

**Referenced by**

- [NasShare.nasSystem](NasShare.md)
- [NasVolume.nasSystem](NasVolume.md)
