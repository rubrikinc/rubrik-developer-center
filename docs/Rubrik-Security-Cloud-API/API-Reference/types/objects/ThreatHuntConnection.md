...
| edges | [[ThreatHuntEdge](ThreatHuntEdge.md)!]! | List of ThreatHunt objects with additional pagination information. Use `nodes` if per-object cursors are not needed. |
| nodes | [[ThreatHunt](ThreatHunt.md)!]! | List of ThreatHunt objects. |
...
- [query: threatHunts](../../queries/threatHunts.md)
