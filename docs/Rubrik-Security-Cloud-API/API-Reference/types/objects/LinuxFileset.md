...
| failoverClusterApp | [FailoverClusterApp](FailoverClusterApp.md) | Failover cluster app. |
| filesetTemplate | [FilesetTemplate](FilesetTemplate.md) | Fileset template of the Linux fileset. |
| hardlinkSupportEnabled | Boolean! | Boolean variable denoting if hard link support is enabled. |
| host | [PhysicalHost](PhysicalHost.md) | Host of the linux fileset. |
...
- [query: linuxFileset](../../queries/linuxFileset.md)
