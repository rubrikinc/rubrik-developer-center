...
| iops | [Long](../scalars/Long.md) | The provisioned IOPS of the recovered RDS instance. |
...
| port | [Long](../scalars/Long.md)! | The port on which the recovered RDS instance will accept connections. |
...
| snapshotType | [SnapshotType](../enums/SnapshotType.md)! | The type of snapshot to be used for recovery. |
...
| version | [Long](../scalars/Long.md)! | The version of the recovery specification. |
...
- [WorkloadSpecificRecoverySpec.awsRdsInstance](WorkloadSpecificRecoverySpec.md)
