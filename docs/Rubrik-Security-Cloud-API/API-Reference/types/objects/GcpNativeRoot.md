...
|-------|------|-------------|
| objectTypeDescendantConnection | [GcpNativeHierarchyObjectConnection](GcpNativeHierarchyObjectConnection.md)! | List of descendants of specific object type. |
...
- [query: gcpNativeRoot](../../queries/gcpNativeRoot.md)
