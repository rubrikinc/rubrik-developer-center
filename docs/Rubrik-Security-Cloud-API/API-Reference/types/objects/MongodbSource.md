...
| backupParams | [MongodbBackupParams](MongodbBackupParams.md) | Backup Parameters for the MongoDB source cluster. |
| cluster | [Cluster](Cluster.md)! | Information about NoSql cluster for this MongoDB cluster. |
| clusterUuid | [UUID](../scalars/UUID.md)! | UUID of the Nosql cluster. |
| configParams | [MongodbSourceConfigParams](MongodbSourceConfigParams.md) | Configuration Params for the MongoDB source cluster. |
| configuredSlaDomain | [SlaDomain](../interfaces/SlaDomain.md)! | SLA Domain configured for the hierarchy object. |
| descendantConnection | [MongodbSourceDescendantTypeConnection](MongodbSourceDescendantTypeConnection.md)! | List of descendants. |
...
| size | [Long](../scalars/Long.md) | Overall data size of MongoDB source cluster in bytes. |
| slaAssignment | [SlaAssignmentTypeEnum](../enums/SlaAssignmentTypeEnum.md)! | SLA Domain assignment type for this object. |
| slaPauseStatus | Boolean! | Pause status of the effective SLA Domain of the hierarchy object. |
| snapshotDistribution | [SnapshotDistribution](SnapshotDistribution.md)! | Distribution of the snapshots of the hierarchy object. |
| sourceIp | String! | IP of the MongoDB source. |
| status | [MongodbSourceStatus](../enums/MongodbSourceStatus.md)! | Source connectivity status. |
...
- [query: mongodbSource](../../queries/mongodbSource.md)
- [query: mongodbSources](../../queries/mongodbSources.md) *(via connection)*

**Referenced by**

- [MongodbCollection.source](MongodbCollection.md)
- [MongodbDatabase.source](MongodbDatabase.md)
