...
|-------|------|-------------|
| bliMigrationStatusType | [BliMigrationStatus](../enums/BliMigrationStatus.md)! | BLI migration status for this RCV Azure target. |
| cluster | [Cluster](Cluster.md)! | The cluster to which this target belongs. |
| clusterIpMapping | [ClusterIpMapping](ClusterIpMapping.md) | IP allow list for location. |
...
| conversionOpt | [RcvConversionType](RcvConversionType.md) | Latest conversion for this RCV Azure location. |
| failedTasks | Int | Number of archiving tasks failed on this target. |
| id | String! | The ID of the target. |
| immutabilityPeriodDays | [Long](../scalars/Long.md)! | Immutability lock duration of RCV Azure target in days. |
...
| lastRedundancySyncTime | [DateTime](../scalars/DateTime.md) | Last time when redundancy state was synchronized for the RCV Azure target. |
...
| redundancyState | [RcvRedundancyState](../enums/RcvRedundancyState.md)! | Redundancy state for RCV Azure target. |
...
| syncStatus | [TargetSyncStatus](../enums/TargetSyncStatus.md)! | Sync status of RCV target. |
...
| tier | [RcsTierEnumType](../enums/RcsTierEnumType.md)! | Tier for RCV target. |
