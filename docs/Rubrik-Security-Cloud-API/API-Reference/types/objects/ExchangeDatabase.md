...
| exchangeServer | [ExchangeServer](ExchangeServer.md)! | Exchange Server parent of the database. |
...
- [query: exchangeDatabase](../../queries/exchangeDatabase.md)
- [query: exchangeDatabases](../../queries/exchangeDatabases.md) *(via connection)*

**Referenced by**

- [ExchangeLiveMount.sourceDatabase](ExchangeLiveMount.md)
