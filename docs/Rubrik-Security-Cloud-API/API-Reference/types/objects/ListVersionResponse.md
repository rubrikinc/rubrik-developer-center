...
|-------|------|-------------|
| data | [[MosaicVersionObject](MosaicVersionObject.md)!]! | Supported in m3.2.0-m4.2.0 Object with Response from ListVersion. |
...
- [query: mosaicSnapshots](../../queries/mosaicSnapshots.md)
- [query: mosaicVersions](../../queries/mosaicVersions.md)
