...
| date | String! | The date the snapshot was taken. This value is formatted as YYYY/MM/DD HH:mm:ss. |
...
| slaDomain | [SlaConfig](SlaConfig.md) | SLA Domain of the snapshot. |
...
- [CdmSnapshot.cdmWorkloadSnapshot](CdmSnapshot.md)
- [MssqlDatabase.cdmNewestSnapshot](MssqlDatabase.md)
- [MssqlDatabase.cdmOldestSnapshot](MssqlDatabase.md)
