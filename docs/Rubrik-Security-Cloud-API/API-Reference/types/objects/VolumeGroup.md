...
| cdmSnapshots | [CdmWorkloadSnapshotConnection](CdmWorkloadSnapshotConnection.md)! | List of snapshots taken for a Volume Group. |
...
| isRelic | Boolean! | Whether the volume group is a relic. |
...
| volumes | [String!]! | Volumes in the volume group. |
