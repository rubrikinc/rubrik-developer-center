...
|-------|------|-------------|
| data | [[NutanixContainer](NutanixContainer.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: nutanixClusterContainers](../../queries/nutanixClusterContainers.md)
