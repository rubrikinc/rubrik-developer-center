...
| registrationCodes | [[OauthAccessToken](OauthAccessToken.md)!]! | Request parameters for an OAuth access token to register with Rubrik Security Cloud. |
...
- [query: oauthCodesForEdgeReg](../../queries/oauthCodesForEdgeReg.md)
