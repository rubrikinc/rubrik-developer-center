...
An OpenStack image: a bootable Glance image within a project.

**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [CdmHierarchySnappableNew](../interfaces/CdmHierarchySnappableNew.md), [HierarchySnappable](../interfaces/HierarchySnappable.md), [OpenstackEnvironmentDescendantType](../interfaces/OpenstackEnvironmentDescendantType.md), [OpenstackEnvironmentLogicalChildType](../interfaces/OpenstackEnvironmentLogicalChildType.md), [OpenstackEnvironmentPhysicalChildType](../interfaces/OpenstackEnvironmentPhysicalChildType.md), [OpenstackRegionDescendantType](../interfaces/OpenstackRegionDescendantType.md), [OpenstackRegionPhysicalChildType](../interfaces/OpenstackRegionPhysicalChildType.md), [OpenstackDomainDescendantType](../interfaces/OpenstackDomainDescendantType.md), [OpenstackDomainLogicalChildType](../interfaces/OpenstackDomainLogicalChildType.md), [OpenstackProjectDescendantType](../interfaces/OpenstackProjectDescendantType.md), [OpenstackProjectLogicalChildType](../interfaces/OpenstackProjectLogicalChildType.md)
...
| isRelic | Boolean! | Whether the OpenStack image is a relic. |
...
| osDistro | String | OS distribution of the OpenStack image. |
| osType | String | OS type of the OpenStack image. |
...
| visibilityType | [OpenstackImageVisibilityType](../enums/OpenstackImageVisibilityType.md)! | Visibility type of the OpenStack image. |
