...
- [query: agentDeploymentSetting](../../queries/agentDeploymentSetting.md)

**Mutations**

- [mutation: updateAgentDeploymentSetting](../../mutations/updateAgentDeploymentSetting.md)

**Referenced by**

- [AgentDeploymentSettingsInfo.agentDeploymentSettings](AgentDeploymentSettingsInfo.md)
