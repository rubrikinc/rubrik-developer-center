...
| cdmId | String! | ID associated with the Exchange Host in CDM. |
...
| descendantConnection | [ExchangeHostDescendantTypeConnection](ExchangeHostDescendantTypeConnection.md)! | List of descendants. |
...
| physicalChildConnection | [ExchangeHostPhysicalChildTypeConnection](ExchangeHostPhysicalChildTypeConnection.md)! | List of physical children. |
| physicalHostMetadata | [PhysicalHostMetadata](PhysicalHostMetadata.md)! | Metadata of the underlying physical host. |
...
- [ExchangeServer.exchangeHost](ExchangeServer.md)
