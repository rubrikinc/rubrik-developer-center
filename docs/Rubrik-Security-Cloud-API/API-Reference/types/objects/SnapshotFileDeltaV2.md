...
- [query: listDiffFilesForSnapshot](../../queries/listDiffFilesForSnapshot.md) *(via connection)*
- [query: snapshotFilesDeltaV2](../../queries/snapshotFilesDeltaV2.md) *(via connection)*
