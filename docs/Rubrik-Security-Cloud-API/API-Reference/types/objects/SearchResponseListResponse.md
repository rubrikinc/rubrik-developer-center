...
|-------|------|-------------|
| data | [[SearchResponse](SearchResponse.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: searchHost](../../queries/searchHost.md)
- [query: searchNutanixVm](../../queries/searchNutanixVm.md)
