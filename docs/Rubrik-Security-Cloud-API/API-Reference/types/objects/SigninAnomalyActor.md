...
| actorType | [ViolationPrincipalType](../enums/ViolationPrincipalType.md)! | The actor's principal type. Empty when the actor cannot be resolved. |
...
- [SigninAnomalyMetadata.actors](SigninAnomalyMetadata.md)
