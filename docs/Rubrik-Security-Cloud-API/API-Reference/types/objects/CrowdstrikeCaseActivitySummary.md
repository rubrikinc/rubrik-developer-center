...
| latestActionTime | [DateTime](../scalars/DateTime.md) | Most recent IDP activity across all actors in the case. Null if no activity in the window. |
...
- [query: crowdstrikeCaseActivitySummary](../../queries/crowdstrikeCaseActivitySummary.md)
