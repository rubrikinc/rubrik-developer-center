...
|-------|------|-------------|
| data | [[AddClusterCertificateReply](AddClusterCertificateReply.md)!]! | Supported in v5.1+ List of matching objects. |
...
- [query: clusterCertificates](../../queries/clusterCertificates.md)
