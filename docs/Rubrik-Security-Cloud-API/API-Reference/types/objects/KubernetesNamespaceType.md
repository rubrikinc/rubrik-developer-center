...
| descendantConnection | [KubernetesNamespaceDescendantConnection](KubernetesNamespaceDescendantConnection.md)! | List of descendants. |
...
| kubernetesDescendantVirtualMachines | [KubernetesVirtualMachineConnection](KubernetesVirtualMachineConnection.md)! | Kubernetes Virtual Machines belonging to the Kubernetes namespace. |
