...
|-------|------|-------------|
| data | [[NetworkInterface](NetworkInterface.md)!]! | Supported in v5.0+ List of matching objects. |
...
- [query: clusterNetworkInterfaces](../../queries/clusterNetworkInterfaces.md)
