...
| policyStatus | [DiscoveryReportTablePolicyStatus](../enums/DiscoveryReportTablePolicyStatus.md)! | Status of the policy. |
...
- [query: sonarReportRow](../../queries/sonarReportRow.md) *(via connection)*
