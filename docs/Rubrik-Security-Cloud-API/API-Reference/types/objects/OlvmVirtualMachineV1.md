...
**Implements:** [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [HierarchyObject](../interfaces/HierarchyObject.md), [HierarchySnappable](../interfaces/HierarchySnappable.md), [CdmHierarchySnappableNew](../interfaces/CdmHierarchySnappableNew.md), [OlvmManagerDescendant](../interfaces/OlvmManagerDescendant.md), [OlvmDatacenterDescendant](../interfaces/OlvmDatacenterDescendant.md), [OlvmComputeClusterDescendant](../interfaces/OlvmComputeClusterDescendant.md), [OlvmTagDescendant](../interfaces/OlvmTagDescendant.md), [OlvmTagLogicalChild](../interfaces/OlvmTagLogicalChild.md), [OlvmManagerPhysicalChildType](../interfaces/OlvmManagerPhysicalChildType.md), [OlvmDatacenterPhysicalChildType](../interfaces/OlvmDatacenterPhysicalChildType.md), [OlvmComputeClusterPhysicalChildType](../interfaces/OlvmComputeClusterPhysicalChildType.md)

## Fields

| Field | Type | Description |
|-------|------|-------------|
| agentStatus | String! | OLVM virtual machine agent status. |
...
| computeClusterId | String! | ID of the OLVM compute cluster that contains this virtual machine. |
...
| olvmId | String! | ID of the virtual machine in OLVM. |
| olvmManagerId | String! | ID of the OLVM manager that manages this virtual machine. |
...
| postBackupScript | [OlvmBackupScript](OlvmBackupScript.md) | Post backup script configuration. |
| postSnapScript | [OlvmBackupScript](OlvmBackupScript.md) | Post snapshot script configuration. |
| preBackupScript | [OlvmBackupScript](OlvmBackupScript.md) | Pre backup script configuration. |
...
| reportWorkload | [Snappable](Snappable.md) | Contains statistics for the protected objects, including physical bytes and archive storage for virtual machine archival. |
| resourceSpec | String! | Resource specification for OLVM virtual machine. |
...
| snapshotConsistencyMandate | [OlvmSnapshotConsistencyMandate](../enums/OlvmSnapshotConsistencyMandate.md)! | Snapshot consistency mandate for the virtual machine. |
...
| templateType | String! | Template type of the virtual machine. |
| vmName | String! | Name of the OLVM virtual machine. |
