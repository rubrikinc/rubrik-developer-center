...
| metadata | [PostgreSQLDbClusterMetadata](PostgreSQLDbClusterMetadata.md)! | The metadata field of PostgreSQL database cluster. |
...
- [query: postgreSQLDbCluster](../../queries/postgreSQLDbCluster.md)
- [query: postgreSQLDbClusters](../../queries/postgreSQLDbClusters.md) *(via connection)*
