...
PostgreSQL database details object.
...
| metadata | [PostgreSQLDatabaseMetadata](PostgreSQLDatabaseMetadata.md)! | The metadata field of PostgreSQL database. |
...
- [query: postgreSQLDatabase](../../queries/postgreSQLDatabase.md)
- [query: postgreSQLDatabases](../../queries/postgreSQLDatabases.md) *(via connection)*
