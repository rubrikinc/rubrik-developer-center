...
| immutabilitySettings | [AwsImmutabilitySettingsType](AwsImmutabilitySettingsType.md) | Immutability settings of the AWS archival target. |
...
| region | [AwsRegion](../enums/AwsRegion.md)! | Region of the AWS location. |
