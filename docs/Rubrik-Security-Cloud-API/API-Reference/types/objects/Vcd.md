...
**Implements:** [HierarchyObject](../interfaces/HierarchyObject.md), [CdmHierarchyObject](../interfaces/CdmHierarchyObject.md), [VcdTopLevelDescendantType](../interfaces/VcdTopLevelDescendantType.md)
...
| allVcenterConnectionStatuses | [[VcdVcenterConnectionState](VcdVcenterConnectionState.md)!]! | The connection status of the vCenter. |
| allVcenterConnectionsInfo | [[VcdVcenterConnectionInfo](VcdVcenterConnectionInfo.md)!]! | The connection statuses of the vCenters that belong to the VCD. |
| authorizedOperations | [[Operation](../enums/Operation.md)!]! | The authorized operations on the object. |
| caCerts | String! | The CA certificates used to connect to the VCD instance. |
| cdmId | String! | The CDM ID of vCD instance. |
...
| descendantConnection | [VcdDescendantTypeConnection](VcdDescendantTypeConnection.md)! | List of descendants. |
| effectiveRetentionSlaDomain | [SlaDomain](../interfaces/SlaDomain.md) | Effective retention of the SLA Domain of the hierarchy object. |
| effectiveSlaDomain | [SlaDomain](../interfaces/SlaDomain.md)! | Effective SLA Domain of the hierarchy object. |
| effectiveSlaSourceObject | [PathNode](PathNode.md) | Path node of the effective SLA Domain source. |
| hostname | String! | The hostname of VCD instance. |
| id | [UUID](../scalars/UUID.md)! | ID of the hierarchy object. |
| latestUserNote | [LatestUserNote](LatestUserNote.md) | Latest user note information. |
| logicalChildConnection | [VcdLogicalChildTypeConnection](VcdLogicalChildTypeConnection.md)! | List of logical children. |
...
| recoveryLogicalChildConnection | [VcdLogicalChildTypeConnection](VcdLogicalChildTypeConnection.md)! | List of recoveryLogical children. |
...
| username | String! | The username used to connect to the VCD instance. |
| vcdConnectionStatus | [HostConnectionStatus](HostConnectionStatus.md) | The connection status of the vCD instance. |
| version | String! | The version of VCD instance. |
