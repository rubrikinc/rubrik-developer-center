...
|-------|------|-------------|
| id | [UUID](../scalars/UUID.md)! | The ID of the snappable. |
| onDemandCount | [Long](../scalars/Long.md)! | Number of on demand snapshots. |
| retrievedCount | [Long](../scalars/Long.md)! | Number of retrieved snapshots. |
| scheduledCount | [Long](../scalars/Long.md)! | Number of scheduled snapshots. |
| totalCount | [Long](../scalars/Long.md)! | Total number of snapshots. |

## Used By

**Referenced by**

- [ActiveDirectoryDomain.snapshotDistribution](ActiveDirectoryDomain.md)
...
- [AwsNativeRdsInstance.snapshotDistribution](AwsNativeRdsInstance.md)
