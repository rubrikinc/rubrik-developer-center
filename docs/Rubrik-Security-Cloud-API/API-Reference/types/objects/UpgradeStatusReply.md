...
| ruInfo | [RollingUpgradeInfo](RollingUpgradeInfo.md) | Rolling upgrade information. |
| tarballName | String! | Upgrade tarball package name. |
| upgradeProgressPercentage | String! | Overall upgrade progress percentage. |
| upgradeStatus | [StatusResponse](StatusResponse.md) | Upgrade status object. |
...
- [query: upgradeStatus](../../queries/upgradeStatus.md)
