...
| id | String! | UUID in our customers used to represent the project within Rubrik. |
...
| organizationName | String! | Organization name of the GCP project. This field is optional and may be empty if the project is not part of an organization. |
...
- [GcpCloudAccountGetProjectResponse.project](GcpCloudAccountGetProjectResponse.md)
