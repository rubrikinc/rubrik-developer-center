...
| groupType | [EntraIDGroupType](../enums/EntraIDGroupType.md)! | Specifies if the group is a Microsoft 365 or a security group. |
| owners | [[EntraIDOwner](EntraIDOwner.md)!]! | Lists all owners of the group. |
