...
| dataTransferred | [Long](../scalars/Long.md)! | Total number of bytes transferred for the task. |
...
| duration | [Long](../scalars/Long.md)! | The time taken to run the task. |
| endTime | [DateTime](../scalars/DateTime.md)! | The time when the task ended. |
| failureReason | String! | The reason for failure if the task failed to complete. |
| id | [Long](../scalars/Long.md)! | The invisible column. |
| location | String! | The location of the task. |
| logicalBytes | [Long](../scalars/Long.md)! | Logical bytes of the task. |
...
| physicalBytes | [Long](../scalars/Long.md)! | Physical bytes of the task. |
...
| startTime | [DateTime](../scalars/DateTime.md)! | The time when the task started. |
| status | String! | The status of the task. |
| taskCategory | String! | The category type of the task. |
| taskOrg | [WorkloadOrganization](WorkloadOrganization.md) | Specifies the owner organization of the workload task detail. |
| taskType | String! | The type of the task. |
| totalFilesTransferred | [Long](../scalars/Long.md)! | Total number of files transferred for the task. |
...
- [query: taskDetailConnection](../../queries/taskDetailConnection.md) *(via connection)*
