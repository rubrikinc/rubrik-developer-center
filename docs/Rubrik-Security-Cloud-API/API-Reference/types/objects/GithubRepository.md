...
| id | [UUID](../scalars/UUID.md)! | ID of the GitHub repository. |
| isRelic | Boolean! | True if the GitHub repository is a relic. |
...
| orgId | [UUID](../scalars/UUID.md)! | Managed Object ID of the GitHub organization associated with the repository. |
| orgName | String! | Name of the GitHub organization associated with the repository. |
...
| size | [Long](../scalars/Long.md)! | Size of the GitHub repository in bytes. |
...
- [query: gitHubRepository](../../queries/gitHubRepository.md)
- [query: gitHubRepositories](../../queries/gitHubRepositories.md) *(via connection)*
