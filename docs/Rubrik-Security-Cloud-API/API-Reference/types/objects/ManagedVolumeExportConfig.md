...
|-------|------|-------------|
| managedVolumePatchConfig | [ManagedVolumePatchConfig](ManagedVolumePatchConfig.md) | Configuration for updating a Managed Volume. |
...
- [ManagedVolumeExport.config](ManagedVolumeExport.md)
