...
| serviceAccounts | [[GcpServiceAccountInput](GcpServiceAccountInput.md)!] | Service accounts to apply to the GCP instance. |
| subnetAzConfigs | [[SubnetAzConfigInput](SubnetAzConfigInput.md)!] | List of subnet and availability zone pairs for Multi-AZ deployments. |
| testImage | [GcpTestImage](GcpTestImage.md) | Test image to use for the Rubrik cluster. This field is only used for internal testing purposes. |
| vmType | [VmType](../enums/VmType.md) | Standard, dense or extra dense virtual machine. |
