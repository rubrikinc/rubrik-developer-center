...
| targetFilePaths | [[MssqlDbFileExportPathInput](MssqlDbFileExportPathInput.md)!] | Supported in v5.0+ One target path for each individual database file. Overrides targetDataFilePath and targetLogFilePath. |
