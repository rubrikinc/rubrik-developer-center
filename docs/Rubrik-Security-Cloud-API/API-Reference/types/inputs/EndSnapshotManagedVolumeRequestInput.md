...
| retentionConfig | [BaseOnDemandSnapshotConfigInput](BaseOnDemandSnapshotConfigInput.md) | Supported in v7.0+ Overridden SLA Domain Id for Managed Volume snapshot. |
