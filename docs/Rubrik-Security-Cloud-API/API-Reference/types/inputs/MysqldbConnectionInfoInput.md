...
|-------|------|-------------|
| authenticationType | [MysqldbAuthenticationType](../enums/MysqldbAuthenticationType.md) | Supported in v9.4+ Authentication type for accessing the instance. |
...
| sslConfig | [MysqldbSslConfigInput](MysqldbSslConfigInput.md) | Supported in v9.4+ SSL configuration of the MySQL instance. |
