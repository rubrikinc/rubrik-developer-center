...
| maxPvcsPerAgent | Int | Supported in v9.6+ Maximum number of PVCs assigned to a single kupr backup agent. Used as a per-group cap for the node_affinity grouping strategy. Defaults to 30 when omitted. Set to 0 to disable the per-agent cap. |
