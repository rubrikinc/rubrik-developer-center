...
| optionalConfig | [AzureExocomputeOptionalConfigInRegionInput](AzureExocomputeOptionalConfigInRegionInput.md) | Optional configurations for aks cluster. |
...
| region | [AzureCloudAccountRegion](../enums/AzureCloudAccountRegion.md)! | The region for which the configuration is specified. |
