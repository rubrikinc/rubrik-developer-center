...
|-------|------|-------------|
| connectionInfo | [MysqldbConnectionInfoInput](MysqldbConnectionInfoInput.md)! | Required. Supported in v9.6+ Connection and authentication settings for this replica. |
