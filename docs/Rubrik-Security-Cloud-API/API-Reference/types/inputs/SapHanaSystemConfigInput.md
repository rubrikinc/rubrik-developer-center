...
|-------|------|-------------|
| authTypeSpec | [SapHanaSystemAuthTypeSpecInput](SapHanaSystemAuthTypeSpecInput.md) | Supported in v9.0+ The authentication type for the SAP HANA system. |
| azureFeatureId | String | Supported in v9.1+ The Rubrik ID of the SAP HANA Azure Feature. |
| backupTriggerType | [SapHanaSystemConfigBackupTriggerType](../enums/SapHanaSystemConfigBackupTriggerType.md) | Supported in v9.4+ The backup trigger type for the SAP HANA system. |
| dataPathSpec | [SapHanaSystemDataPathSpecInput](SapHanaSystemDataPathSpecInput.md) | Supported in v6.0+ Data path details of the SAP HANA system. |
