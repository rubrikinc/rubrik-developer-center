...
| managedVolumeSnapshotReferenceWrapper | [ManagedVolumeSnapshotReferenceWrapperInput](ManagedVolumeSnapshotReferenceWrapperInput.md) | A wrapper around ManagedVolumeSnapshotReference. |
