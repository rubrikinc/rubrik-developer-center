...
|-------|------|-------------|
| cloudProvider | [CloudDirectCloudProvider](../enums/CloudDirectCloudProvider.md)! | Cloud provider to provision the virtual machine in. |
| cloudRegion | String | Cloud region to provision the virtual machine in. |
| clusterUuid | [UUID](../scalars/UUID.md)! | The UUID of the NAS Cloud Direct cluster to provision the virtual machine for. |
