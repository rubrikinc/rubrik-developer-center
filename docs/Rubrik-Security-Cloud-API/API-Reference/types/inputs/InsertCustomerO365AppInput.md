...
|-------|------|-------------|
| appCertificateExpiry | [DateTime](../scalars/DateTime.md) | Expiration date of the app certificate. |
| appClientId | String! | ID of the app. |
| appClientSecret | String! | Secret for the app. |
| appSecretExpiry | [DateTime](../scalars/DateTime.md) | Expiration date of the app secret. |
