...
|-------|------|-------------|
| activityId | [UUID](../scalars/UUID.md)! | Mandatory -- activity event ID for audit correlation. |
| activityTimestamp | String! | Mandatory -- RFC3339 timestamp of the identity event. |
| activityType | [IdentityAlertEventType](../enums/IdentityAlertEventType.md)! | Mandatory -- type of the identity event. |
