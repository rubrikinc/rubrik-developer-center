...
|-------|------|-------------|
| pointInTime | [DateTime](../scalars/DateTime.md) | Supported in v9.5+ Point in time for which the base full snapshot and the log snapshots should be downloaded for recovery. The date-time string must be in the ISO8601 format. For example, "2016-01-01T01:23:45.678". The timezone is same as the timezone of the Rubrik cluster. |
