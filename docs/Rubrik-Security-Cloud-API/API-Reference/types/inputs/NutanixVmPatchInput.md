...
| postBackupScript | [NutanixVirtualMachineScriptDetailInput](NutanixVirtualMachineScriptDetailInput.md) | Supported in v6.0+ |
| postSnapScript | [NutanixVirtualMachineScriptDetailInput](NutanixVirtualMachineScriptDetailInput.md) | Supported in v6.0+ |
| preBackupScript | [NutanixVirtualMachineScriptDetailInput](NutanixVirtualMachineScriptDetailInput.md) | Supported in v6.0+ |
