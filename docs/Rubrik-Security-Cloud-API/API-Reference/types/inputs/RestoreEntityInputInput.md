...
| logSnapshotTimeRange | [RestoreLogSnapshotTimeRangeInput](RestoreLogSnapshotTimeRangeInput.md) | Supported in v9.2+ Time range for the log snapshots to be restored. |
