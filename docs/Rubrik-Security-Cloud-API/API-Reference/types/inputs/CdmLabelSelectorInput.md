...
|-------|------|-------------|
| matchExpressions | [[LabelSelectorRequirementInput](LabelSelectorRequirementInput.md)!] | List of label selector requirements. All requirements must be satisfied for a match. |
