...
|-------|------|-------------|
| config | [BeginSnapshotManagedVolumeRequestInput](BeginSnapshotManagedVolumeRequestInput.md) | Details about the reference to be added to the snapshot and the type of request. |
