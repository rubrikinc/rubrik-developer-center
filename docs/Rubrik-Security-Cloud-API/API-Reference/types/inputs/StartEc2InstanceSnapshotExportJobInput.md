...
| destinationAwsAccountRubrikId | [UUID](../scalars/UUID.md)! | Rubrik UUID of the AWS account where the instance will be exported. |
| destinationRegionId | [AwsNativeRegion](../enums/AwsNativeRegion.md)! | Region of the exported instance. |
