...
| shouldEnableZeroRpo | Boolean | Supported in v9.6 Enable or disable Zero RPO (near-zero recovery point) protection. When enabled, Oracle redo logs are streamed in real-time to CDM. Requires librubrik.so and Log Forwarder components on the host. |
