...
| scope | [LambdaTargetScope](../enums/LambdaTargetScope.md)! | The scope of the target. For instance, target of scope principal is target of type user / group / service principal. |
