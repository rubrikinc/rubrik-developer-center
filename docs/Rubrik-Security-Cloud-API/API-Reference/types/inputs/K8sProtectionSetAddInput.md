...
| customResourceDependencies | [[CustomResourceDependencyInput](CustomResourceDependencyInput.md)!] | Supported in v9.6+ Custom Resource types to capture alongside workloads. Only valid when rsType is "application". |
