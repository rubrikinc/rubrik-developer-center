...
|-------|------|-------------|
| restoreConfig | [[OpenstackRestoreFileConfigInput](OpenstackRestoreFileConfigInput.md)!]! | Required. Supported in v9.5+ Array containing the full path of the source and target location for each file being restored. |
