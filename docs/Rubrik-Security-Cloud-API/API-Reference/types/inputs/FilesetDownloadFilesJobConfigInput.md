...
|-------|------|-------------|
| legalHoldDownloadConfig | [LegalHoldDownloadConfigInput](LegalHoldDownloadConfigInput.md) | Supported in v5.2+ An optional argument containing a Boolean parameter to depict if the download is being triggered for Legal Hold use case. |
