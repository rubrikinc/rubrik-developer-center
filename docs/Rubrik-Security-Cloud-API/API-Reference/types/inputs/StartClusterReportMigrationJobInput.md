...
|-------|------|-------------|
| clusterUuid | [UUID](../scalars/UUID.md) | The Rubrik cluster ID. If the cluster ID is not provided, the job will perform migration of reports for all the eligible clusters connected. |
