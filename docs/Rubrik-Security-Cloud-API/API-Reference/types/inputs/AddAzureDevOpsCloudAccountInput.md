...
| storageType | [DevOpsStorageType](../enums/DevOpsStorageType.md) | Type of storage -- BYOS (Bring Your Own Storage) or RCV (Rubrik Cloud Vault). BYOS requires backup_location_id; RCV auto-provisions storage. |
