...
| sourceConfig | [SapHanaRestoreSourceConfigInput](SapHanaRestoreSourceConfigInput.md)! | Required. The object containing configuration related metadata for the source SAP HANA database. |
