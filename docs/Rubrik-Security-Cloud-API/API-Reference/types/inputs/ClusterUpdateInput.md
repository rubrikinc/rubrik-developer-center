...
| geolocation | [ClusterGeolocationInput](ClusterGeolocationInput.md) | New geolocation for a Rubrik cluster. |
| name | String | New name for a Rubrik cluster. |
| timezone | [ClusterTimezoneInput](ClusterTimezoneInput.md) | New time zone for a Rubrik cluster. |
