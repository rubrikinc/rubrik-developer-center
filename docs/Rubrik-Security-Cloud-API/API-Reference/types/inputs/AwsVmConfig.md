...
| instanceType | [AwsInstanceType](../enums/AwsInstanceType.md) | AWS instance type. |
| networkConfig | [[AwsVmNetworkConfig](AwsVmNetworkConfig.md)!] | Network config per node. Has one entry per node. |
...
| vmType | [VmType](../enums/VmType.md) | Create dense or standard nodes. |
