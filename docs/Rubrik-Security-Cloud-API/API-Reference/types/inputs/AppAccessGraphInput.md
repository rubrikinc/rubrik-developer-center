...
| activityType | [IdentityAlertEventType](../enums/IdentityAlertEventType.md) | Activity kind associated with the activityId. Required when activityId is set; identifies the event type for impact classification. |
