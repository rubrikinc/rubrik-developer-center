...
|-------|------|-------------|
| azureSqlManagedInstanceDbLtrExportInput | [AzureSqlManagedInstanceDbLtrExport](AzureSqlManagedInstanceDbLtrExport.md) | Input for exporting from Long Term Retention (LTR) backup. |
| azureSqlManagedInstanceDbPitExportInput | [AzureSqlManagedInstanceDbPitExport](AzureSqlManagedInstanceDbPitExport.md) | Input for exporting from Point-in-Time (PiT) backup. |
...
| destinationManagedInstanceRubrikId | [UUID](../scalars/UUID.md) | Destination Rubrik ID of the Asure SQL Managed Instance to which export will be done. |
...
| sourceManagedInstanceDatabaseRubrikId | [UUID](../scalars/UUID.md)! | Rubrik ID of the Azure SQL Managed Instance Database to be exported. |
