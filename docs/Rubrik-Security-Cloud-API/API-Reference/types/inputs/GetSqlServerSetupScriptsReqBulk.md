...
|-------|------|-------------|
| serverIds | [[UUID](../scalars/UUID.md)!] | The server_ids is the list of server ids for which the script is needed. Each server id correspond to the rubrik id of the server. |
