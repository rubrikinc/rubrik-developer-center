...
|-------|------|-------------|
| multiPostgresRestoreSettings | [[PerObjectPostgresRestoreSettingsInput](PerObjectPostgresRestoreSettingsInput.md)!] | Supported in v9.6+ Per-host restore settings. Required for multi-host targets; takes precedence over postgresRestoreSettings. Must list every entry in hostRestoreTargets exactly once. |
