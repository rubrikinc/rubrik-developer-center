...
| mountExportSnapshotJobCommonOptions | [MountExportSnapshotJobCommonOptionsInput](MountExportSnapshotJobCommonOptionsInput.md) | Common options for virtual machine mount. |
