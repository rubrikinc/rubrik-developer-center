...
|-------|------|-------------|
| downloadConfig | [SapHanaDownloadRequestInput](SapHanaDownloadRequestInput.md) | Additional configuration for the download operation. This includes the SLA Domain assigned to the downloaded snapshot. |
