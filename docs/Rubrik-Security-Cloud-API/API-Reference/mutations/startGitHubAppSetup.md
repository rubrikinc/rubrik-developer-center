...
|----------|------|-------------|
| input *(required)* | [StartGitHubAppSetupInput](../types/inputs/StartGitHubAppSetupInput.md)! | Input for setting up GitHub Apps. |

## Returns

[StartGitHubAppSetupReply](../types/objects/StartGitHubAppSetupReply.md)!
