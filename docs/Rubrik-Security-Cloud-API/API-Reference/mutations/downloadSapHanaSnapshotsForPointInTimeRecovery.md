...
|----------|------|-------------|
| input *(required)* | [DownloadSapHanaSnapshotsForPointInTimeRecoveryInput](../types/inputs/DownloadSapHanaSnapshotsForPointInTimeRecoveryInput.md)! | Input for V1DownloadSapHanaSnapshotsForPointInTimeRecovery. |
