...
|----------|------|-------------|
| input *(required)* | [CreateAutomaticRcsTargetMappingInput](../types/inputs/CreateAutomaticRcsTargetMappingInput.md)! | Request argument for creating a new Rubrik Cloud Vault location. |
