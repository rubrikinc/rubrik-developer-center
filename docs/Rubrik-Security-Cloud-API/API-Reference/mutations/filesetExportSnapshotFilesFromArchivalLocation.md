...
|----------|------|-------------|
| input *(required)* | [FilesetExportSnapshotFilesFromArchivalLocationInput](../types/inputs/FilesetExportSnapshotFilesFromArchivalLocationInput.md)! | Input for fileset export snapshot files from archival location. |
