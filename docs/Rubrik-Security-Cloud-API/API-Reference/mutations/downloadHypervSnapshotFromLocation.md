...
|----------|------|-------------|
| input *(required)* | [DownloadHypervSnapshotFromLocationInput](../types/inputs/DownloadHypervSnapshotFromLocationInput.md)! | Input for DownloadHyperVSnapshotFromLocationRequest. |
