...
|----------|------|-------------|
| input *(required)* | [VsphereVmExportSnapshotWithDownloadFromCloudInput](../types/inputs/VsphereVmExportSnapshotWithDownloadFromCloudInput.md)! | Input for V2CreateExportWithDownloadFromCloudV2. |
