...
|----------|------|-------------|
| input *(required)* | [ClearCloudNativeSqlServerBackupCredentialsInput](../types/inputs/ClearCloudNativeSqlServerBackupCredentialsInput.md)! | Input required to clear the credentials used for SQL Server backups. |

## Returns

[ClearCloudNativeSqlServerBackupCredentialsReply](../types/objects/ClearCloudNativeSqlServerBackupCredentialsReply.md)!
