...
|----------|------|-------------|
| input *(required)* | [DownloadVsphereVirtualMachineFilesInput](../types/inputs/DownloadVsphereVirtualMachineFilesInput.md)! | Input for V1CreateDownloadVirtualMachineFileJob. |
