...
|----------|------|-------------|
| input *(required)* | [DownloadFusionComputeSnapshotFromLocationInput](../types/inputs/DownloadFusionComputeSnapshotFromLocationInput.md)! | Input for downloadFusionComputeSnapshotFromLocation. |
