...
|----------|------|-------------|
| input *(required)* | [DownloadVolumeGroupSnapshotFromLocationInput](../types/inputs/DownloadVolumeGroupSnapshotFromLocationInput.md)! | Input for V1DownloadVolumeGroupSnapshotFromLocation. |
