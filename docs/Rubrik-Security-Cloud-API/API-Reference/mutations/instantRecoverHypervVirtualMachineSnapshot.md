...
|----------|------|-------------|
| input *(required)* | [InstantRecoverHypervVirtualMachineSnapshotInput](../types/inputs/InstantRecoverHypervVirtualMachineSnapshotInput.md)! | InstantRecoverHypervVMSnapshotRequest. |
