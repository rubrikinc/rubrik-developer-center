...
|----------|------|-------------|
| input *(required)* | [DownloadHypervVirtualMachineSnapshotFilesInput](../types/inputs/DownloadHypervVirtualMachineSnapshotFilesInput.md)! | Input for DownloadHypervVMSnapshotFilesRequest. |
