...
|----------|------|-------------|
| input *(required)* | [VsphereSnapshotRestoreFilesFromLocationInput](../types/inputs/VsphereSnapshotRestoreFilesFromLocationInput.md)! | List of backup throttle settings. |
