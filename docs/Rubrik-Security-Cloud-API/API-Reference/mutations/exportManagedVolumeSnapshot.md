...
|----------|------|-------------|
| input *(required)* | [ExportManagedVolumeSnapshotInput](../types/inputs/ExportManagedVolumeSnapshotInput.md)! | Input for the mutation to export a Managed Volume snapshot. |
