...
|----------|------|-------------|
| input *(required)* | [ExpireMongoCollectionSetDownloadedSnapshotsInput](../types/inputs/ExpireMongoCollectionSetDownloadedSnapshotsInput.md)! | Input for V1ExpireMongoCollectionSetDownloadedSnapshots. |
