...
|----------|------|-------------|
| input *(required)* | [DownloadFilesetSnapshotFromLocationInput](../types/inputs/DownloadFilesetSnapshotFromLocationInput.md)! | Input for V2DownloadFilesetSnapshotFromLocation. |
