...
|----------|------|-------------|
| input *(required)* | [DownloadFilesFromFusionComputeSnapshotInput](../types/inputs/DownloadFilesFromFusionComputeSnapshotInput.md)! | Input for downloading files from a FusionCompute virtual machine snapshot. |
