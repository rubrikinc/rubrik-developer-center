...
|----------|------|-------------|
| input *(required)* | [UpdatePureStorageProtectionGroupQuiesceTargetsInput](../types/inputs/UpdatePureStorageProtectionGroupQuiesceTargetsInput.md)! | Parameters for replacing the persisted quiesce-target selection of a Pure Storage protection group. |

## Returns

[UpdatePureStorageProtectionGroupQuiesceTargetsReply](../types/objects/UpdatePureStorageProtectionGroupQuiesceTargetsReply.md)!
