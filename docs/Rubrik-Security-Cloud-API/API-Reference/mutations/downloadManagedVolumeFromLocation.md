...
|----------|------|-------------|
| input *(required)* | [DownloadManagedVolumeFromLocationInput](../types/inputs/DownloadManagedVolumeFromLocationInput.md)! | Input for V1ManagedVolumeDownloadFromLocation. |
