...
|----------|------|-------------|
| input *(required)* | [UpdateO365AppAuthStatusInput](../types/inputs/UpdateO365AppAuthStatusInput.md)! | Input for updating the Microsoft 365 app authentication status. |
