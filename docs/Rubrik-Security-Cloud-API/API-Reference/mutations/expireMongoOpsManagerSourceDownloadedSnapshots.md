...
|----------|------|-------------|
| input *(required)* | [ExpireMongoOpsManagerSourceDownloadedSnapshotsInput](../types/inputs/ExpireMongoOpsManagerSourceDownloadedSnapshotsInput.md)! | Input for V2ExpireMongoOpsManagerSourceDownloadedSnapshots. |
