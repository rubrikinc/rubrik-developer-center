...
|----------|------|-------------|
| input *(required)* | [AddMysqldbInstanceInput](../types/inputs/AddMysqldbInstanceInput.md)! | Input for V1AddMysqldbInstance. |

## Returns

[AddMysqldbInstanceResponse](../types/objects/AddMysqldbInstanceResponse.md)!
