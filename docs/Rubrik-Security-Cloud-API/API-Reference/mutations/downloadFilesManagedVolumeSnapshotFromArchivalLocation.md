...
|----------|------|-------------|
| input *(required)* | [CreateMVDownloadFilesFromArchivalLocationJobInput](../types/inputs/CreateMVDownloadFilesFromArchivalLocationJobInput.md)! | Input for V1CreateMVDownloadFilesFromArchivalLocationJob. |
