...
|----------|------|-------------|
| input *(required)* | [DownloadOracleSnapshotFromLocationInput](../types/inputs/DownloadOracleSnapshotFromLocationInput.md)! | Input for V1DownloadOracleSnapshotFromLocation. |
