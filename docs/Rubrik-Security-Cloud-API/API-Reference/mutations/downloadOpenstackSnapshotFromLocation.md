...
|----------|------|-------------|
| input *(required)* | [DownloadOpenstackSnapshotFromLocationInput](../types/inputs/DownloadOpenstackSnapshotFromLocationInput.md)! | Input for V1DownloadOpenstackVmSnapshotFromLocation. |
