...
|----------|------|-------------|
| input *(required)* | [DeletePostgresDbClusterLiveMountInput](../types/inputs/DeletePostgresDbClusterLiveMountInput.md)! | Input for V1DeletePostgresDbClusterLiveMount. |
