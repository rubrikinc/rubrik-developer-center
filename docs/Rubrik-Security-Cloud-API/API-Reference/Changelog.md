...
??? note "3 fields removed from `Mutation`"
...
??? note "3 enum values added to enum `TprRule`"
...
??? note "21 fields added to `K8sClusterSummary`"
...
??? note "4 input fields added to `PostgresRestoreSettingsInput`"
...
??? note "5 fields added to `ProxmoxStorageDomain`"
...
??? note "3 fields added to `RegistryPatternSpec`"
...
??? note "17 enum values added to enum `AwsCloudExternalArtifact`"
...
??? note "5 fields added to `Mutation`"
...
??? note "13 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "12 enum values added to enum `AuditObjectType`"
...
??? note "13 enum values added to enum `EventObjectType`"
...
??? note "4 enum values added to enum `HierarchyFilterField`"
...
??? note "12 enum values added to enum `HierarchyObjectTypeEnum`"
...
??? note "12 enum values added to enum `ManagedObjectType`"
...
??? note "5 enum values added to enum `WorkloadLevelHierarchy`"
...
??? note "3 fields added to `Mutation`"
...
??? note "4 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "4 enum values added to enum `AzureAdObjectType`"
...
??? note "5 enum values added to enum `DataGovObjectType`"
...
??? note "4 enum values added to enum `EventObjectType`"
...
??? note "3 enum values added to enum `HierarchyObjectTypeEnum`"
...
??? note "3 enum values added to enum `ManagedObjectType`"
...
??? note "3 enum values added to enum `SnapshotLocType`"
...
??? note "4 fields added to `AzureAdObjects`"
...
??? note "4 fields added to `Mutation`"
...
??? note "11 fields added to `MysqlTopologyReplicaInfo`"
...
??? note "3 fields added to `GetAnomalyDetailsReply`"
...
??? note "6 fields removed from `Mutation`"
...
??? note "13 fields removed from `Query`"
...
??? note "3 enum values added to enum `AirGatewayProvisioningState`"
...
??? note "3 enum values added to enum `FilterType`"

    - `SECURITY_SAAS_ACTIVITY_ACTOR`
    - `SECURITY_SAAS_ACTIVITY_ORG`
    - `SECURITY_SAAS_ACTIVITY_TYPE`

??? note "3 enum values added to enum `HierarchyFilterField`"
...
??? note "5 fields added to `M365OneDriveRecoveryPlanFilterLeaf`"
...
??? note "5 fields added to `M365SharePointRecoveryPlanFilterLeaf`"
...
??? note "3 fields added to `ThreatHuntingObjectFileMatch`"
...
??? note "7 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "4 enum values added to enum `ArchivalMigrationStatus`"
...
??? note "7 enum values added to enum `AuditObjectType`"
...
??? note "3 enum values added to enum `AuthorizedOperation`"
...
??? note "7 enum values added to enum `EventObjectType`"
...
??? note "15 enum values added to enum `FilterType`"
...
??? note "14 enum values added to enum `GpoSettingName`"
...
??? note "9 enum values added to enum `HierarchyObjectTypeEnum`"
...
??? note "9 enum values added to enum `ManagedObjectType`"
...
??? note "6 enum values added to enum `ObjectTypeEnum`"
...
??? note "3 enum values added to enum `Operation`"
...
??? note "8 enum values added to enum `PolarisReportViewType`"
...
??? note "10 enum values added to enum `TableViewType`"
...
??? note "3 fields added to `ActivityEntry`"

    - `classification`
    - `classificationSources`
    - `classifiedOn`

??? note "3 fields added to `AzureAdDirectory`"
...
??? note "13 fields added to `ClusterNodeStats`"
...
??? note "3 input fields added to `CompleteAzureAdAppSetupInput`"
...
??? note "4 enum values added to enum `AuditObjectType`"
...
??? note "4 enum values added to enum `ReportAttribute`"
...
??? note "6 enum values added to enum `ReportMeasure`"
...
??? note "6 enum values added to enum `TableViewType`"
...
??? note "3 fields added to `AwsNativeS3Bucket`"
...
??? note "3 fields added to `Db2Database`"
...
??? note "3 fields added to `K8sClusterSummary`"
...
??? note "3 fields added to `M365AbrRecoveryPlan`"
...
??? note "3 fields added to `MysqldbInstance`"
...
??? note "5 fields added to `RcvActionsTprReqChangesTemplate`"
...
??? note "6 enum values added to enum `PermissionsGroup`"
...
??? note "4 enum values added to enum `SaasAppType`"
...
??? note "4 enum values added to enum `UserAuditObjectTypeEnum`"
...
??? note "18 fields added to `ActiveDirectoryAppMetadata`"
...
??? note "3 fields added to `AwsNativeAccount`"

    - `s3TablesIcebergCatalogCount`
    - `s3TablesIcebergNamespaceCount`
    - `s3TablesIcebergTableCount`

??? note "3 fields added to `AwsNativeRegionHierarchyObject`"
...
??? note "13 fields added to `Mutation`"
...
??? note "3 fields added to `WindowsDiskInfo`"
...
??? note "9 enum values added to enum `HierarchyFilterField`"
...
??? note "3 fields added to `IOCDetails`"
...
??? note "4 fields added to `RubrikManagedRcvAwsTarget`"
...
??? note "3 enum values added to enum `ActivityObjectTypeEnum`"

    - `S3_TABLES_ICEBERG_CATALOG`
    - `S3_TABLES_ICEBERG_NAMESPACE`
    - `S3_TABLES_ICEBERG_TABLE`

??? note "3 enum values added to enum `AuditObjectType`"
...
??? note "3 enum values added to enum `EventObjectType`"
...
??? note "5 enum values added to enum `HierarchySortByField`"
...
??? note "3 enum values added to enum `PolarisReportViewType`"
...
??? note "9 enum values added to enum `TableViewType`"
...
??? note "14 fields added to `Mutation`"
...
??? note "9 enum values added to enum `ArchivalMigrationStatus`"
...
??? note "7 enum values added to enum `HierarchyFilterField`"
...
??? note "5 enum values added to enum `PolarisReportViewType`"
...
??? note "15 enum values added to enum `TableViewType`"
...
??? note "6 fields added to `AzurePostgresFlexibleServer`"
...
??? note "3 input fields added to `K8sTransformsInput`"
...
??? note "3 fields added to `MssqlDbDetail`"
...
??? note "9 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "9 enum values added to enum `AuditObjectType`"
...
??? note "9 enum values added to enum `EventObjectType`"
...
??? note "5 enum values added to enum `ExoHealthCheckType`"
...
??? note "3 enum values added to enum `HelpContentSource`"
...
??? note "5 enum values added to enum `RcsRegionEnumType`"
...
??? note "3 fields added to `HelpContentSnippet`"
...
??? note "5 fields added to `KnowledgeBaseArticle`"
...
??? note "4 fields added to `ProductDocumentation`"
...
??? note "4 enum values added to enum `AuthorizedOperation`"
...
??? note "5 enum values added to enum `HierarchyFilterField`"
...
??? note "11 enum values added to enum `ObjectTypeEnum`"
...
??? note "4 enum values added to enum `Operation`"
...
??? note "3 enum values added to enum `TableViewType`"
...
??? note "10 enum values added to enum `WorkloadLevelHierarchy`"
...
??? note "5 input fields added to `K8sClusterAddInput`"
...
??? note "3 input fields added to `K8sClusterUpdateConfigInput`"
...
??? note "6 fields added to `Mutation`"
...
??? note "3 fields added to `OracleDataGuardGroup`"

    - `isZeroRpoEnabled`
    - `logRatePerRmanChannelInMb`
    - `ratePerRmanChannelInMb`

??? note "3 fields added to `OracleRacDetail`"
...
??? note "4 enum values added to enum `AzureAdRelationshipEnumType`"
...
??? note "3 enum values added to enum `AzureAdReverseRelationshipType`"
...
??? note "13 enum values added to enum `HierarchyObjectTypeEnum`"
...
??? note "8 enum values added to enum `ProductName`"
...
??? note "8 fields added to `AzureExocomputeConfigValidationInfo`"
...
??? note "7 fields added to `AzurePostgresFlexibleServer`"
...
??? note "5 fields added to `IntuneDeviceManagementSecretSetting`"
...
??? note "4 fields added to `KubernetesProtectionSet`"
...
??? note "4 fields added to `OracleRac`"
...
??? note "8 enum values added to enum `DataGovObjectType`"
...
??? note "7 fields added to `Mutation`"
...
??? note "5 fields added to `ArchivalObjectInfo`"
...
??? note "3 enum values added to enum `AzureAdObjectSearchType`"

    - `GROUP_ACTIVE_ASSIGNMENT_GROUP_NAME`
    - `GROUP_ACTIVE_ASSIGNMENT_PRINCIPAL_NAME`
    - `REVIEW_SCOPE_OBJ_TYPE`

??? note "5 enum values added to enum `AzureAdRelationshipEnumType`"
...
??? note "15 enum values added to enum `AzureAdReverseRelationshipType`"
...
??? note "5 fields added to `AzureAdRoleEligibleAssignment`"
...
??? note "5 enum values added to enum `AuthorizedOperation`"
...
??? note "4 enum values added to enum `AzureAdObjectSearchType`"
...
??? note "5 enum values added to enum `Operation`"
...
??? note "5 enum values added to enum `PolicyViolationSortField`"
...
??? note "3 enum values added to enum `PrincipalRiskySummaryPrincipalType`"
...
??? note "3 enum values added to enum `ViolationPrincipalType`"
...
??? note "28 enum values removed from enum `IntuneDeviceManagementPolicyType`"
...
??? note "19 enum values removed from enum `IntuneDeviceManagementSecretSettingType`"
...
??? note "4 enum values added to enum `ActiveDirectoryObjectType`"
...
??? note "13 enum values added to enum `AzureAdObjectSearchType`"
...
??? note "3 enum values added to enum `AzureInstanceType`"
...
??? note "8 enum values added to enum `IntuneAppProtectionManagementType`"
...
??? note "36 enum values added to enum `IntuneDeviceManagementPolicyType`"
...
??? note "19 enum values added to enum `IntuneDeviceManagementSecretSettingType`"
...
??? note "20 fields added to `Mutation`"
...
??? note "10 enum values added to enum `AzureAdObjectType`"
...
??? note "5 enum values added to enum `IntuneDevicePlatformType`"
...
??? note "4 enum values added to enum `TargetEncryptionTypeEnum`"
...
??? note "12 fields added to `AzureAdObjects`"
...
??? note "11 fields added to `MssqlInstance`"
...
??? note "7 fields added to `SigninLogSummary`"
...
??? note "8 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "8 enum values added to enum `AzureAdObjectType`"
...
??? note "7 enum values added to enum `AzureAdRelationshipEnumType`"
...
??? note "8 enum values added to enum `EventObjectType`"
...
??? note "22 enum values added to enum `FilterType`"
...
??? note "11 enum values added to enum `NativeType`"
...
??? note "9 enum values added to enum `PrincipalRiskySummaryPrincipalType`"
...
??? note "6 enum values added to enum `SigninLogFilterType`"
...
??? note "3 fields added to `AzureAdGroup`"

    - `isPimEnabled`
    - `memberPolicy`
    - `ownerPolicy`

??? note "8 fields added to `AzureAdObjects`"
...
??? note "17 enum values added to enum `AzureAdObjectType`"
...
??? note "3 enum values added to enum `AzureAdRelationshipEnumType`"
...
??? note "4 enum values added to enum `FileResultSortBy`"
...
??? note "4 enum values added to enum `HierarchyObjectTypeEnum`"
...
??? note "5 enum values added to enum `ManagedObjectType`"
...
??? note "6 fields added to `FailoverGroupArchivalLocation`"
...
??? note "5 fields added to `GcpNativeGceInstanceSpecificSnapshot`"
...
??? note "12 fields added to `Mutation`"
...
??? note "4 fields added to `K8sProtectionSetSummary`"
...
??? note "4 enum values added to enum `AwsCloudAccountRegion`"
...
??? note "4 enum values added to enum `AwsCommonRegion`"
...
??? note "4 enum values added to enum `AwsNativeRegion`"
...
??? note "3 enum values added to enum `AwsRegion`"
...
??? note "6 enum values added to enum `DataGovObjectType`"
...
??? note "6 enum values added to enum `HierarchyFilterField`"
...
??? note "10 fields added to `Mutation`"
...
??? note "3 fields added to `RscReportTemplate`"
...
??? note "10 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "10 enum values added to enum `EventObjectType`"
...
??? note "8 enum values added to enum `HierarchyObjectTypeEnum`"
...
??? note "8 enum values added to enum `ManagedObjectType`"
...
??? note "7 enum values added to enum `UserAuditObjectTypeEnum`"
...
??? note "5 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "6 enum values added to enum `EventObjectType`"
...
??? note "6 enum values added to enum `PrincipalRiskySummaryPrincipalType`"
...
??? note "4 fields added to `AzureCloudAccountRolePermission`"
...
??? note "4 fields added to `AzureExocomputeConfigValidationInfo`"
...
??? note "9 fields added to `Mutation`"
...
??? note "7 enum values added to enum `FailoverStatusEnum`"
...
??? note "3 enum values added to enum `GcpCloudSqlInstanceSortFields`"
...
??? note "4 enum values added to enum `HierarchySortByField`"
...
??? note "6 fields added to `AzureAdDirectory`"
...
??? note "3 input fields added to `GcpCloudSqlInstanceFilters`"
...
??? note "3 fields added to `RcvConversionType`"
...
??? note "3 enum values added to enum `ActivityTypeEnum`"
...
??? note "8 enum values added to enum `AwsInstanceType`"
...
??? note "6 enum values added to enum `AzureAdObjectType`"
...
??? note "6 enum values added to enum `AzureAdRelationshipEnumType`"
...
??? note "3 enum values added to enum `EventType`"
...
??? note "5 enum values added to enum `GcpRegion`"
...
??? note "6 fields added to `AzureAdObjects`"
...
??? note "4 fields added to `ObjectTypeUsage`"
...
??? note "8 enum values added to enum `AwsNativeRdsDbEngine`"
...
??? note "4 fields added to `AwsExocomputeConfig`"
...
??? note "3 enum values added to enum `O365MvbAnalysisJobStatus`"
...
??? note "4 enum values added to enum `PermissionsGroup`"
...
??? note "3 enum values added to enum `RcsRegionEnumType`"
...
??? note "3 fields added to `RecoveryAnalysisMetadata`"
...
??? note "21 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "21 enum values added to enum `EventObjectType`"
...
??? note "19 enum values added to enum `PrincipalRiskySummaryPrincipalType`"
...
??? note "3 fields added to `ActiveDirectoryAppMetadata`"
...
??? note "6 enum values added to enum `ActivityObjectTypeEnum`"
...
??? note "5 enum values added to enum `PrincipalRiskySummaryPrincipalType`"
...
??? note "3 enum values removed from enum `FailoverGroupStatus`"
...
??? note "7 enum values added to enum `FailoverGroupStatus`"
...
??? note "4 enum values added to enum `ManagedObjectType`"
...
??? note "8 fields added to `ClusterDisk`"
...
??? note "4 fields added to `NasNamespace`"
...
??? note "3 enum values added to enum `AzureCloudAccountRegion`"

    - `CHILECENTRAL`
    - `INDONESIACENTRAL`
    - `MALAYSIAWEST`

??? note "3 enum values added to enum `AzureNativeRegion`"

    - `CHILE_CENTRAL`
    - `INDONESIA_CENTRAL`
    - `MALAYSIA_WEST`

??? note "3 enum values added to enum `AzureNativeRegionForReplication`"
...
??? note "4 fields added to `DiskStatus`"
...
??? note "7 fields removed from `Mutation`"
...
??? note "7 enum values added to enum `CloudDirectNasVendorType`"
...
??? note "4 fields added to `AzureAdDirectory`"
...
??? note "16 enum values added to enum `RcsRegionEnumType`"
...
??? note "4 fields added to `CustomReportInfo`"
...
??? note "3 fields added to `DiskStatus`"
...
??? note "5 enum values added to enum `EventObjectType`"
...
??? note "3 enum values added to enum `AzureRegion`"
...
??? note "3 fields added to `GcpNativeDisk`"

    - `attachmentSpecs`
    - `gcpNativeProjectDetails`
    - `gcpProject`

??? note "3 fields added to `GcpNativeGceInstance`"
...
??? note "3 enum values added to enum `AzureAdObjectType`"
...
??? note "3 fields added to `AzureAdObjects`"
...
??? note "8 enum values added to enum `AuditObjectType`"
...
??? note "5 enum values added to enum `HierarchyObjectTypeEnum`"
...
??? note "5 enum values added to enum `UserAuditObjectTypeEnum`"
...
??? note "7 fields added to `UiStatusAttributes`"
...
??? note "43 enum values added to enum `S3CompatibleSubType`"
...
??? note "3 fields added to `AzureExocomputeConfigValidationInfo`"
...
??? note "3 enum values added to enum `FlowErrorCode`"

    - `AZURE_SQL_ELASTIC_POOL_UNSUPPORTED`
    - `RDS_DB_PERSISTENT_OR_PERMANENT`
    - `RDS_DB_UNSUPPORTED_ENGINE`

??? note "8 enum values added to enum `HierarchyFilterField`"
...
??? note "5 fields added to `CloudDirectNasNamespace`"
...
??? note "5 fields added to `CloudDirectNasSystem`"
