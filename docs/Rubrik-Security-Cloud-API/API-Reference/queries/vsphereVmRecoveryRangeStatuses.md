...
|----------|------|-------------|
| input *(required)* | [VsphereVmRecoveryRangeStatusReq](../types/inputs/VsphereVmRecoveryRangeStatusReq.md)! | Request containing virtual machine FID and time range for recovery status. |

## Returns

[VsphereVmRecoveryRangeStatusResp](../types/objects/VsphereVmRecoveryRangeStatusResp.md)!
