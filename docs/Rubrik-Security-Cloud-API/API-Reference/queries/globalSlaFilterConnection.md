...
| sortBy | [SlaQuerySortByField](../types/enums/SlaQuerySortByField.md) | Field to sort the SLA Domains list. |
| sortOrder | [SortOrder](../types/enums/SortOrder.md) | Sort order for sorting the SLA Domains returned by the query. |
| filter | [[GlobalSlaFilterInput](../types/inputs/GlobalSlaFilterInput.md)!] | Filter for the SLA Domain query. |
| contextFilter | [ContextFilterTypeEnum](../types/enums/ContextFilterTypeEnum.md) | Specifies the context filter to use. |
| contextFilterInput | [[ContextFilterInputField](../types/inputs/ContextFilterInputField.md)!] | Specifies the context filter input to use. |
...
[GlobalSlaForFilterConnection](../types/objects/GlobalSlaForFilterConnection.md)!
