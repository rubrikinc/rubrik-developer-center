...
|----------|------|-------------|
| azureManagedDiskRubrikId *(required)* | [UUID](../types/scalars/UUID.md)! | Rubrik ID of the Azure Managed Disk. |
| includeSecurityMetadata | Boolean | Filter to include the security metadata. |

## Returns

[AzureNativeManagedDisk](../types/objects/AzureNativeManagedDisk.md)!
