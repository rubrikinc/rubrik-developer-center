...
|----------|------|-------------|
| input *(required)* | [ListAllUploadRecordsInput](../types/inputs/ListAllUploadRecordsInput.md)! | Input for listAllUploadRecords. |

## Returns

[ListAllUploadRecordsReply](../types/objects/ListAllUploadRecordsReply.md)!
